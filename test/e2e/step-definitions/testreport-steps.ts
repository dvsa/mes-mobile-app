...
import {
  CompetencyObject,
  DriverFaultsObject, ETAObject, LegalRequirementsObject,
  ReversingDiagramModalObject, TestReportPageObject,
...
const driverFaults : DriverFaults= new DriverFaults();
const driverFaultsElement : DriverFaultsObject = new DriverFaultsObject();
const competencyElement : CompetencyObject = new CompetencyObject();
const legalRequirement : LegalRequirements = new LegalRequirements();
const legalRequirementObject : LegalRequirementsObject = new LegalRequirementsObject();
const eta : ETA = new ETA();
const etaElement : ETAObject = new ETAObject();
const reversingDiagramModal : ReversingDiagramModal = new ReversingDiagramModal();
const reversingDiagramModalElement : ReversingDiagramModalObject = new ReversingDiagramModalObject();
