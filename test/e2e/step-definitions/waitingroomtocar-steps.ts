...
const waitingRoomToCarPage : WaitingRoomToCarPage = new WaitingRoomToCarPage();
const waitingRoomToCarPageElement : WaitingRoomToCarPageObject = new WaitingRoomToCarPageObject();
