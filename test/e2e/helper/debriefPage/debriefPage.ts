...
export class DebriefPage extends Page {
  ...
  clickEndDebriefButtonWelsh() {
    this.clickElement(this.debriefPageElement.endDebriefButtonWelsh);
  }
  ...
  clickContinueToNonPassFinalisationButton(testCategory: string) {
    this.clickElement(this.debriefPageElement.ContinueToNonPassFinalisationButton(testCategory));
  }
