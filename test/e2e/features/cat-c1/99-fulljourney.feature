...
Feature: Full end to end journey for Category c1
   ...
   Scenario: Examiner completes a failed test with various faults
      Given I am logged in as "mobexaminer5" and I have a test for "Ms Rachel Faulkner"
      When I check candidate details for "Ms Rachel Faulkner"
      And I start the test for "Ms Rachel Faulkner"
      And the candidate completes the declaration page
      And the candidate confirms their declaration
      Then I should see the "Declaration - Rachel Faulkner" page
      And the candidate enters a new email address
      And I proceed to the car
      Then I should see the "Rachel Faulkner" page
      ...
      Then I should see the "Test report - Rachel Faulkner" page
      ...
      And I should see the "Test report - Rachel Faulkner" page
      ...
      And I upload the test
      Then I should see the "Journal" page
      And the test result for "Ms Rachel Faulkner" is "2"
