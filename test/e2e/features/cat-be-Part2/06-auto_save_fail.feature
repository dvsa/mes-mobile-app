...
Feature: Autosave end to end failed journey for Category B+E
   ...
   Given I am logged in as "mobexaminer2" and I have a test for "Mr Patrick Patricks"
   When I check candidate details for "Mr Patrick Patricks"
   And I start the test for "Mr Patrick Patricks"
   And the candidate completes the declaration page
   And the candidate confirms their declaration
   Then I should see the "Declaration - Patrick Patricks" page
   And the candidate enters a new email address
   And I proceed to the car
   Then I should see the "Patrick Patricks" page
   ...
   Then I should see the "Test report - Patrick Patricks" page
   ...
   When I search for a completed test with the application reference of "11654327011"
   ...
   And I should see the "Journal" page
   Then I continue the write up for "Mr Patrick Patricks"
   ...
   And the test result for "Mr Patrick Patricks" is "2"
