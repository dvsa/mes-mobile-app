...
describe('IncompleteTestsBannerSelector', function () {
    var slotProvider;
    ...
    describe('getIncompleteTestsCount', function () {
        it('should get a count of incomplete tests', function () {
            var _a;
            var journal = {
                isLoading: true,
            ...
            var count = getIncompleteTestsCount(journal, tests, DateTime.at('2019-01-14'), slotProvider);
            expect(count).toBe(3);
        });
    });
});
//# sourceMappingURL=incomplete-tests-banner.selector.spec.js.map