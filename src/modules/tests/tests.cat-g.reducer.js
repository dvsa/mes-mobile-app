...
import { testDataCatGReducer } from './test-data/cat-home-test/test-data.cat-g.reducer';
...
export function testsCatGReducer(action, state) {
...
//# sourceMappingURL=tests.cat-g.reducer.js.map