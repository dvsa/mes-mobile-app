...
import { testDataCatFReducer } from './test-data/cat-home-test/test-data.cat-f.reducer';
...
export function testsCatFReducer(action, state) {
...
//# sourceMappingURL=tests.cat-f.reducer.js.map