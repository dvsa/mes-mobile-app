...
import { RecordManoeuvresSelection, AddManoeuvreDrivingFault, AddManoeuvreSeriousFault, AddManoeuvreDangerousFault, AddManoeuvreComment, RemoveManoeuvreFault, } from '../manoeuvres.actions';
import { CompetencyOutcome } from '../../../../../../shared/models/competency-outcome';
describe('ADI2 Manoeuvres Reducer', function () {
    describe('RECORD_MANOEUVRES_SELECTION', function () {
        it('should add selected manoeuvre at position 1', function () {
            var state = [{}, {}];
            var result = manoeuvresCatADI2Reducer(state, new RecordManoeuvresSelection(ManoeuvreTypes.reverseParkRoad, 0));
            expect(result[0][ManoeuvreTypes.reverseParkRoad]).toEqual({ selected: true });
        });
        it('should add selected manoeuvre at position 2', function () {
            var state = [{}, {}];
            var result = manoeuvresCatADI2Reducer(state, new RecordManoeuvresSelection(ManoeuvreTypes.reverseParkRoad, 1));
            expect(result[1][ManoeuvreTypes.reverseParkRoad]).toEqual({ selected: true });
        });
        it('should replace current with selected manoeuvre at position 1', function () {
            var state = [{
                    reverseParkCarpark: {
                        selected: true,
                    },
        ...
        it('should replace current with selected manoeuvre at position 2', function () {
            var state = [{}, {
                    reverseParkCarpark: {
                        selected: true,
                    },
    ...
    describe('ADD_MANOEUVRE_DRIVING_FAULT', function () {
        it('should add a "DF" outcome to the selected manoeuvre at position 1', function () {
            var state = [{
                    reverseParkRoad: { selected: true },
                }, {
                    reverseParkCarpark: { selected: true },
                }];
            var result = manoeuvresCatADI2Reducer(state, new AddManoeuvreDrivingFault({
        ...
        it('should add a "DF" outcome to the selected manoeuvre at position 2', function () {
            var state = [{
                    reverseParkRoad: { selected: true },
                }, {
                    reverseParkCarpark: { selected: true },
    ...
    describe('ADD_MANOEUVRE_SERIOUS_FAULT', function () {
        it('should add a "S" outcome to the selected manoeuvre at position 1', function () {
            var state = [{
                    reverseParkRoad: { selected: true },
                }, {
                    reverseParkCarpark: { selected: true },
                }];
            var result = manoeuvresCatADI2Reducer(state, new AddManoeuvreSeriousFault({
                manoeuvre: ManoeuvreTypes.reverseParkRoad,
                competency: ManoeuvreCompetencies.controlFault,
            }, 0));
        ...
        it('should add a "S" outcome to the selected manoeuvre at position 2', function () {
            var state = [{
                    reverseParkRoad: { selected: true },
                }, {
                    reverseParkCarpark: { selected: true },
    ...
    describe('ADD_MANOEUVRE_DANGEROUS_FAULT', function () {
        it('should add a "D" outcome to the selected manoeuvre at position 1', function () {
            var state = [{
                    reverseParkRoad: { selected: true },
                }, {
                    reverseParkCarpark: { selected: true },
                }];
            var result = manoeuvresCatADI2Reducer(state, new AddManoeuvreDangerousFault({
                manoeuvre: ManoeuvreTypes.reverseParkRoad,
                competency: ManoeuvreCompetencies.controlFault,
            }, 0));
        ...
        it('should add a "D" outcome to the selected manoeuvre at position 2', function () {
            var state = [{
                    reverseParkRoad: { selected: true },
                }, {
                    reverseParkCarpark: { selected: true },
    ...
    describe('ADD_MANOEUVRE_COMMENT', function () {
        it('should add a comment to the selected Manoeuvre', function () {
            ...
            var result = manoeuvresCatADI2Reducer(state, new AddManoeuvreComment(ManoeuvreTypes.reverseParkRoad, CompetencyOutcome.S, 'control', 'comments', 0));
            expect(result[0].reverseParkRoad.controlFaultComments).toEqual('comments');
        });
    });
    describe('REMOVE_MANOEUVRE_FAULT', function () {
        it('should remove the fault from a manoeuvre at position 1', function () {
            var state = [{
            ...
            var result = manoeuvresCatADI2Reducer(state, new RemoveManoeuvreFault({
                competency: ManoeuvreCompetencies.controlFault,
                manoeuvre: ManoeuvreTypes.reverseParkRoad,
            }, 0));
            expect(result[0].reverseParkRoad.controlFault).toBeUndefined();
        ...
        it('should remove the fault from a manoeuvre at position 2', function () {
            var state = [{
                    reverseParkRoad: { selected: true, controlFault: CompetencyOutcome.DF },
                }, {
                    reverseParkCarpark: { selected: true, controlFault: CompetencyOutcome.DF },
