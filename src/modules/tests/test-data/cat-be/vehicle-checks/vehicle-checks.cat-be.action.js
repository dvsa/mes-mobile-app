export var SHOW_ME_QUESTION_SELECTED = '[VehicleChecksPage] [CatBE] Show Me Question Selected';
export var SHOW_ME_QUESTION_OUTCOME_CHANGED = '[VehicleChecksPage] [CatBE] Show Me Question Outcome Changed';
export var TELL_ME_QUESTION_SELECTED = '[VehicleChecksPage] [CatBE] Tell Me Question Selected';
export var TELL_ME_QUESTION_OUTCOME_CHANGED = '[VehicleChecksPage] [CatBE] Tell Me Question Outcome Changed';
export var ADD_SHOW_ME_TELL_ME_COMMENT = '[Vehicle Checks] [CatBE] Add Show me Tell me comment';
export var VEHICLE_CHECKS_COMPLETED = '[Vehicle Checks] [CatBE] Vehicle Checks Completed';
export var VEHICLE_CHECKS_DRIVING_FAULTS_NUMBER_CHANGED = '[Vehicle Checks] [CatBE] Vehicle Checks Driving Faults Number Changed';
...
//# sourceMappingURL=vehicle-checks.cat-be.action.js.map