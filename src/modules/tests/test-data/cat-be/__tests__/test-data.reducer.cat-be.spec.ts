import { testDataReducerCatBE, initialState } from '../test-data.reducer.cat-be';
import {
  AddDrivingFault,
  AddSeriousFault,
...
fdescribe('TestDataReducer reducer', () => {
  describe('ADD_DRIVING_FAULT', () => {
    ...
    it('should update a driving fault when it already exists', () => {
      ...
      const result = testDataReducerCatBE(state, new AddDrivingFault({
        competency: Competencies.controlsGears,
        newFaultCount: 2,
      }));
  ...
  describe('ADD SERIOUS FAULT', () => {
    it('should add a serious fault when none exist', () => {
      const result = testDataReducerCatBE(initialState, new AddSeriousFault(Competencies.followingDistance));
    ...
    it('should update serious fault which already exists', () => {
      ...
      const result = testDataReducerCatBE(state, new AddSeriousFault(Competencies.followingDistance));
      expect(result.seriousFaults.followingDistance).toEqual(true);
    });
    it('should not remove an existing serious fault when a new one is added', () => {
      ...
      const result = testDataReducerCatBE(state, new AddSeriousFault(Competencies.judgementCrossing));
      expect(result.seriousFaults.followingDistance).toEqual(true);
  ...
  describe('manoeuvres', () => {
    it('should add selected manoeuvre', () => {
      const result = testDataReducerCatBE(
        initialState,
  ...
  describe('ADD_DANGEROUS_FAULT', () => {
    it('should add a dangerous fault when none exists', () => {
      const result = testDataReducerCatBE(initialState, new AddDangerousFault(Competencies.followingDistance));
    ...
    it('should update dangerous fault which already exists', () => {
      ...
      const result = testDataReducerCatBE(state, new AddDangerousFault(Competencies.followingDistance));
      expect(result.dangerousFaults.followingDistance).toEqual(true);
    });
    ...
    it('should not remove an existing dangerous fault when a new one is added', () => {
      ...
      const result = testDataReducerCatBE(state, new AddDangerousFault(Competencies.judgementCrossing));
      expect(result.dangerousFaults.followingDistance).toEqual(true);
  ...
  describe('TOGGLE NORMAL START 1', () => {
    it('should toggle normal start 1 to complete (true) when dispatched first time', () => {
      ...
      const result = testDataReducerCatBE(state, new ToggleLegalRequirement(LegalRequirements.normalStart1));
    ...
    it('should toggle normal start 1 to incomplete (false) when dispatched second time', () => {
      ...
      const modifiedState = testDataReducerCatBE(state, new ToggleLegalRequirement(LegalRequirements.normalStart1));
      const result = testDataReducerCatBE(modifiedState, new ToggleLegalRequirement(LegalRequirements.normalStart1));
  ...
  describe('TOGGLE NORMAL START 2', () => {
    it('should toggle normal start 2 to complete (true) when dispatched first time', () => {
      ...
      const result = testDataReducerCatBE(state, new ToggleLegalRequirement(LegalRequirements.normalStart2));
    ...
    it('should toggle normal start 2 to incomplete (false) when dispatched second time', () => {
      ...
      const modifiedState = testDataReducerCatBE(state, new ToggleLegalRequirement(LegalRequirements.normalStart2));
      const result = testDataReducerCatBE(modifiedState, new ToggleLegalRequirement(LegalRequirements.normalStart2));
  ...
  describe('TOGGLE ANGLED START', () => {
    it('should toggle angeld start to complete (true) when dispatched first time', () => {
      ...
      const result = testDataReducerCatBE(state, new ToggleLegalRequirement(LegalRequirements.angledStart));
    ...
    it('should toggle angled start to incomplete (false) when dispatched second time', () => {
      ...
      const modifiedState = testDataReducerCatBE(state, new ToggleLegalRequirement(LegalRequirements.angledStart));
      const result = testDataReducerCatBE(modifiedState, new ToggleLegalRequirement(LegalRequirements.angledStart));
  ...
  describe('TOGGLE HILL START', () => {
    it('should toggle hill start to complete (true) when dispatched first time', () => {
      ...
      const result = testDataReducerCatBE(state, new ToggleLegalRequirement(LegalRequirements.hillStart));
    ...
    it('should toggle hill start to incomplete (false) when dispatched second time', () => {
      ...
      const modifiedState = testDataReducerCatBE(state, new ToggleLegalRequirement(LegalRequirements.hillStart));
      const result = testDataReducerCatBE(modifiedState, new ToggleLegalRequirement(LegalRequirements.hillStart));
  ...
  describe('TOGGLE_ECO', () => {
    it('should toggle eco (true when dispatched first time)', () => {
      ...
      const result = testDataReducerCatBE(state, new ToggleEco());
    ...
    it('should toggle eco (false when dispatched second time)', () => {
      ...
      const modifiedState = testDataReducerCatBE(state, new ToggleEco());
      const result = testDataReducerCatBE(modifiedState, new ToggleEco());
  ...
  describe('TOGGLE_CONTROL_ECO', () => {
    it('should toggle control eco fault (true when dispatched first time)', () => {
      ...
      const result = testDataReducerCatBE(state, new ToggleControlEco());
    ...
    it('should toggle control eco fault (false when dispatched second time)', () => {
      ...
      const modifiedState = testDataReducerCatBE(state, new ToggleControlEco());
      const result = testDataReducerCatBE(modifiedState, new ToggleControlEco());
  ...
  describe('TOGGLE_PLANNING_ECO', () => {
    it('should toggle the planning eco fault (true when dispatched first time)', () => {
      ...
      const result = testDataReducerCatBE(state, new TogglePlanningEco());
    ...
    it('should toggle planning eco fault (false when dispatched second time)', () => {
      ...
      const modifiedState = testDataReducerCatBE(state, new TogglePlanningEco());
      const result = testDataReducerCatBE(modifiedState, new TogglePlanningEco());
  ...
  describe('TOGGLE_CONTROLLED_STOP', () => {
    it('should toggle the controlled stop (true when dispatched first time)', () => {
      ...
      const result = testDataReducerCatBE(state, new ToggleControlledStop());
    ...
    it('should remove the controlled stop property when dispatched second time', () => {
      ...
      const modifiedState = testDataReducerCatBE(state, new ToggleControlledStop());
      const result = testDataReducerCatBE(modifiedState, new ToggleControlledStop());
  ...
  describe('TOGGLE ETA VERBAL', () => {
    it('should toggle ETA verbal to true when dispatched first time', () => {
      ...
      const result = testDataReducerCatBE(state, new ToggleETA(ExaminerActions.verbal));
    ...
    it('should toggle ETA verbal to false when dispatched second time', () => {
      ...
      const modifiedState = testDataReducerCatBE(state, new ToggleETA(ExaminerActions.verbal));
      const result = testDataReducerCatBE(modifiedState, new ToggleETA(ExaminerActions.verbal));
  ...
  describe('TOGGLE ETA PHYSICAL', () => {
    it('should toggle ETA physical to true when dispatched first time', () => {
      ...
      const result = testDataReducerCatBE(state, new ToggleETA(ExaminerActions.physical));
    ...
    it('should toggle ETA physical to false when dispatched second time', () => {
      ...
      const modifiedState = testDataReducerCatBE(state, new ToggleETA(ExaminerActions.physical));
      const result = testDataReducerCatBE(modifiedState, new ToggleETA(ExaminerActions.physical));
  ...
  describe(('REMOVE_DRIVING_FAULT'), () => {
    it('should remove a fault if the fault count is higher then 0', () => {
      ...
      const result = testDataReducerCatBE(state, new RemoveDrivingFault({
  ...
  describe(('REMOVE_SERIOUS_FAULT'), () => {
    it('should remove the competency from the state when a fault is removed', () => {
      ...
      const result = testDataReducerCatBE(state, new RemoveSeriousFault(Competencies.controlsGears));
  ...
  describe(('REMOVE_DANGEROUS_FAULT'), () => {
    it('should remove the competency from the state when a fault is removed', () => {
      ...
      const result = testDataReducerCatBE(state, new RemoveDangerousFault(Competencies.controlsGears));
  ...
  describe('VehicleChecks', () => {
    it('should set the question details and reset outcome when a tell me question is selected', () => {
      ...
      const result = testDataReducerCatBE(oldState, new TellMeQuestionSelected(newQuestionPayload));
    ...
    it('should mark tell me question as pass when the action is received', () => {
      const result = testDataReducerCatBE({ vehicleChecks: {} }, new TellMeQuestionCorrect());
    ...
    it('should mark tell me question as driving fault when the action is received', () => {
      const result = testDataReducerCatBE({ vehicleChecks: {} }, new TellMeQuestionDrivingFault());
    ...
    it('should update the show me question details', () => {
      ...
      const result = testDataReducerCatBE(oldState, new ShowMeQuestionSelected(newQuestionPayload));
      expect(result.vehicleChecks.showMeQuestion.code).toBe('S1');
  ...
  describe('EYESIGHT_TEST_PASSED', () => {
    it('updates the complete status to true', () => {
      ...
      const result = testDataReducerCatBE(state, new EyesightTestPassed());
  ...
  describe('EYESIGHT_TEST_FAILED', () => {
    it('updates the eyesight status to failed', () => {
      ...
      const result = testDataReducerCatBE(state, new EyesightTestFailed());
  ...
  describe('EYESIGHT_TEST_RESET', () => {
    it('updates the complete status to false', () => {
      ...
      const result = testDataReducerCatBE(state, new EyesightTestReset());
  ...
  describe('EYESIGHT_TEST_ADD_COMMENT', () => {
    it('sets the eyesight test fault comments', () => {
      ...
      const result = testDataReducerCatBE(state, new EyesightTestAddComment('Eyesight test comment'));
