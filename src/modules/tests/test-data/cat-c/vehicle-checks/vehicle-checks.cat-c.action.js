export var INITIALIZE_VEHICLE_CHECKS = '[VehicleChecksPage] [CatC] Initialize Vehicle Checks';
export var SHOW_ME_QUESTION_SELECTED = '[VehicleChecksPage] [CatC] Show Me Question Selected';
export var SHOW_ME_QUESTION_OUTCOME_CHANGED = '[VehicleChecksPage] [CatC] Show Me Question Outcome Changed';
export var TELL_ME_QUESTION_SELECTED = '[VehicleChecksPage] [CatC] Tell Me Question Selected';
export var TELL_ME_QUESTION_OUTCOME_CHANGED = '[VehicleChecksPage] [CatC] Tell Me Question Outcome Changed';
export var ADD_SHOW_ME_TELL_ME_COMMENT = '[Vehicle Checks] [CatC] Add Show me Tell me comment';
export var VEHICLE_CHECKS_COMPLETED = '[Vehicle Checks] [CatC] Vehicle Checks Completed';
export var VEHICLE_CHECKS_DRIVING_FAULTS_NUMBER_CHANGED = '[Vehicle Checks] [CatC] Vehicle Checks Driving Faults Number Changed';
...
//# sourceMappingURL=vehicle-checks.cat-c.action.js.map