...
export const hasManoeuvreBeenCompletedCatBE = (data: CatCUniqueTypes.TestData) => {
  return (
...
export const hasVehicleChecksBeenCompletedCatBE = (data: CatCUniqueTypes.TestData): boolean => {
