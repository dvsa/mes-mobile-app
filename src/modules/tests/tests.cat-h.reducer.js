...
import { testDataCatHReducer } from './test-data/cat-home-test/test-data.cat-h.reducer';
...
export function testsCatHReducer(action, state) {
...
//# sourceMappingURL=tests.cat-h.reducer.js.map