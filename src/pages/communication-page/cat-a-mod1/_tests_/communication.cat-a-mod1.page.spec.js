...
describe('CommunicationCatAMod1Page', function () {
    var fixture;
    var component;
    var store$;
    ...
    describe('Class', function () {
        ...
        describe('Provided email selected', function () {
            it('should dispatch a CandidateChoseEmailAsCommunicationPreference action', function () {
                ...
                expect(store$.dispatch)
                    .toHaveBeenCalledWith(new communicationPreferenceActions.CandidateChoseEmailAsCommunicationPreference(candidateMock.emailAddress, CommunicationCatAMod1Page.email));
            });
        });
        ...
        describe('Post selected', function () {
            it('should dispatch a CandidateChosePostAsCommunicationPreference action', function () {
                ...
                expect(store$.dispatch)
                    .toHaveBeenCalledWith(new communicationPreferenceActions.CandidateChosePostAsCommunicationPreference(CommunicationCatAMod1Page.post));
            });
        });
        describe('Communication class level funcitons', function () {
            it('should set setCommunicationType', function () {
                component.setCommunicationType(CommunicationCatAMod1Page.email, CommunicationCatAMod1Page.providedEmail);
                expect(component.communicationType).toEqual(CommunicationCatAMod1Page.email);
                expect(component.emailType).toEqual(CommunicationCatAMod1Page.providedEmail);
            });
            it('should return true for isProvidedEmailSelected() if appropriate properties are defined', function () {
                component.communicationType = CommunicationCatAMod1Page.email;
                component.emailType = CommunicationCatAMod1Page.providedEmail;
            ...
            it('should return true for isNewEmailSelected() if appropriate properties are defined', function () {
                component.communicationType = CommunicationCatAMod1Page.email;
                component.emailType = CommunicationCatAMod1Page.updatedEmail;
...
//# sourceMappingURL=communication.cat-a-mod1.page.spec.js.map