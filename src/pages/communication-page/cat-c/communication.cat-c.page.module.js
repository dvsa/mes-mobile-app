...
var CommunicationCatCPageModule = /** @class */ (function () {
    function CommunicationCatCPageModule() {
    }
    CommunicationCatCPageModule = __decorate([
        NgModule({
            declarations: [
    ...
    ], CommunicationCatCPageModule);
    return CommunicationCatCPageModule;
}());
export { CommunicationCatCPageModule };
//# sourceMappingURL=communication.cat-c.page.module.js.map