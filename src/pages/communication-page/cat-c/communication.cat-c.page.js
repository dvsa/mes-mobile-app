...
var CommunicationCatCPage = /** @class */ (function (_super) {
    __extends(CommunicationCatCPage, _super);
    function CommunicationCatCPage(store$, navController, platform, authenticationProvider, deviceAuthenticationProvider, translate) {
    ...
    CommunicationCatCPage_1 = CommunicationCatCPage;
    CommunicationCatCPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    CommunicationCatCPage.prototype.clickBack = function () {
        this.navController.pop();
    };
    CommunicationCatCPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    CommunicationCatCPage.prototype.ionViewWillEnter = function () {
        if (this.subscription.closed && this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    CommunicationCatCPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    CommunicationCatCPage.prototype.onSubmit = function () {
        var _this = this;
        ...
        if (this.form.valid) {
            this.deviceAuthenticationProvider.triggerLockScreen()
                ...
                _this.navController.push(CAT_C.WAITING_ROOM_TO_CAR_PAGE)
                    .then(function () {
                    var waitingRoomPage = _this.navController.getViews().find(function (view) { return view.id === CAT_C.WAITING_ROOM_PAGE; });
                    if (waitingRoomPage) {
                        _this.navController.removeView(waitingRoomPage);
                    }
                    var communicationPage = _this.navController.getViews().find(function (view) { return view.id === CAT_C.COMMUNICATION_PAGE; });
    ...
    CommunicationCatCPage.prototype.dispatchCandidateChoseProvidedEmail = function () {
        this.setCommunicationType(CommunicationCatCPage_1.email, CommunicationCatCPage_1.providedEmail);
        this.store$.dispatch(new CandidateChoseEmailAsCommunicationPreference(this.candidateProvidedEmail, CommunicationCatCPage_1.email));
    };
    CommunicationCatCPage.prototype.dispatchCandidateChoseNewEmail = function (communicationEmail) {
        this.store$.dispatch(new CandidateChoseEmailAsCommunicationPreference(communicationEmail, CommunicationCatCPage_1.email));
    };
    CommunicationCatCPage.prototype.setCommunicationType = function (communicationChoice, emailType) {
    ...
    CommunicationCatCPage.prototype.isProvidedEmailSelected = function () {
        return (this.communicationType === CommunicationCatCPage_1.email
            && this.emailType === CommunicationCatCPage_1.providedEmail);
    };
    CommunicationCatCPage.prototype.isNewEmailSelected = function () {
        return (this.communicationType === CommunicationCatCPage_1.email
            && this.emailType === CommunicationCatCPage_1.updatedEmail);
    };
    CommunicationCatCPage.prototype.isPostSelected = function () {
        return this.communicationType === CommunicationCatCPage_1.post;
    };
    CommunicationCatCPage.prototype.dispatchCandidateChosePost = function () {
        this.setCommunicationType(CommunicationCatCPage_1.post);
        this.store$.dispatch(new CandidateChosePostAsCommunicationPreference(CommunicationCatCPage_1.post));
    };
    CommunicationCatCPage.prototype.getFormValidation = function () {
        return {
     ...
     */
    CommunicationCatCPage.prototype.restoreRadiosFromState = function () {
        if (this.communicationType === CommunicationCatCPage_1.email) {
     ...
     * rehydrated.
     */
    CommunicationCatCPage.prototype.assertEmailType = function () {
    ...
    CommunicationCatCPage.prototype.restoreRadioValidators = function () {
     ...
     *
     */
    CommunicationCatCPage.prototype.initialiseDefaultSelections = function () {
        this.communicationType = CommunicationCatCPage_1.email;
    ...
    CommunicationCatCPage.prototype.verifyNewEmailFormControl = function (communicationChoice) {
        var newEmailCtrl = this.form.get('newEmailCtrl');
        if (newEmailCtrl !== null) {
            if (communicationChoice !== CommunicationCatCPage_1.email
                || this.emailType === CommunicationCatCPage_1.providedEmail) {
    ...
    CommunicationCatCPage.prototype.shouldPreselectADefaultValue = function () {
        return this.communicationType === CommunicationCatCPage_1.notProvided;
    };
    /**
     ...
     */
    CommunicationCatCPage.prototype.conditionalDispatchCandidateChoseNewEmail = function () {
        this.setCommunicationType(CommunicationCatCPage_1.email, CommunicationCatCPage_1.updatedEmail);
        if (this.isNewEmailSelected() && this.communicationEmail !== '') {
            this.dispatchCandidateChoseNewEmail(this.communicationEmail);
        }
    };
    CommunicationCatCPage.prototype.getNewEmailAddressValue = function () {
        return this.candidateProvidedEmail === this.communicationEmail ? '' : this.communicationEmail;
    };
    var CommunicationCatCPage_1;
    CommunicationCatCPage.providedEmail = 'Provided';
    CommunicationCatCPage.updatedEmail = 'Updated';
    CommunicationCatCPage.email = 'Email';
    CommunicationCatCPage.post = 'Post';
    CommunicationCatCPage.notProvided = 'Not provided';
    CommunicationCatCPage.welshLanguage = 'Cymraeg';
    CommunicationCatCPage.englishLanguage = 'English';
    __decorate([
        ViewChild(Navbar),
        __metadata("design:type", Navbar)
    ], CommunicationCatCPage.prototype, "navBar", void 0);
    CommunicationCatCPage = CommunicationCatCPage_1 = __decorate([
        IonicPage(),
        Component({
            selector: '.communication-cat-c-page',
            templateUrl: 'communication.cat-c.page.html',
        }),
    ...
    return CommunicationCatCPage;
}(BasePageComponent));
export { CommunicationCatCPage };
//# sourceMappingURL=communication.cat-c.page.js.map