...
export class CommunicationCatCPage extends BasePageComponent implements OnInit {
  ...
  dispatchCandidateChoseProvidedEmail() {
    this.setCommunicationType(CommunicationCatCPage.email, CommunicationCatCPage.providedEmail);
    this.store$.dispatch(
      new CandidateChoseEmailAsCommunicationPreference(
        this.candidateProvidedEmail, CommunicationCatCPage.email),
    );
  }
  ...
  dispatchCandidateChoseNewEmail(communicationEmail: string): void {
    this.store$.dispatch(
      new CandidateChoseEmailAsCommunicationPreference(
        communicationEmail, CommunicationCatCPage.email),
    );
  }
  ...
  isProvidedEmailSelected() {
    return (this.communicationType === CommunicationCatCPage.email
      && this.emailType === CommunicationCatCPage.providedEmail);
  }

  isNewEmailSelected() {
    return (this.communicationType === CommunicationCatCPage.email
      && this.emailType === CommunicationCatCPage.updatedEmail);
  }

  isPostSelected() {
    return this.communicationType === CommunicationCatCPage.post;
  }

  dispatchCandidateChosePost(): void {
    this.setCommunicationType(CommunicationCatCPage.post);
    this.store$.dispatch(
      new CandidateChosePostAsCommunicationPreference(CommunicationCatCPage.post),
    );
  }
  ...
  restoreRadiosFromState() {
    if (this.communicationType === CommunicationCatCPage.email) {
  ...
  initialiseDefaultSelections() {
    this.communicationType = CommunicationCatCPage.email;
  ...
  verifyNewEmailFormControl(communicationChoice: string) {
    ...
    if (newEmailCtrl !== null) {
      if (communicationChoice !== CommunicationCatCPage.email
        || this.emailType === CommunicationCatCPage.providedEmail) {
  ...
  shouldPreselectADefaultValue(): boolean {
    return this.communicationType === CommunicationCatCPage.notProvided;
  }
  ...
  conditionalDispatchCandidateChoseNewEmail() {
    this.setCommunicationType(CommunicationCatCPage.email, CommunicationCatCPage.updatedEmail);
