...
describe('CommunicationCatCPCPage', function () {
    var fixture;
    var component;
    var store$;
    ...
    beforeEach(async(function () {
        fixture = TestBed.createComponent(CommunicationCatCPCPage);
    ...
    describe('Class', function () {
        ...
        describe('Provided email selected', function () {
            it('should dispatch a CandidateChoseEmailAsCommunicationPreference action', function () {
                ...
                expect(store$.dispatch)
                    .toHaveBeenCalledWith(new communicationPreferenceActions.CandidateChoseEmailAsCommunicationPreference(candidateMock.emailAddress, CommunicationCatCPCPage.email));
            });
        });
        ...
        describe('Post selected', function () {
            it('should dispatch a CandidateChosePostAsCommunicationPreference action', function () {
                ...
                expect(store$.dispatch)
                    .toHaveBeenCalledWith(new communicationPreferenceActions.CandidateChosePostAsCommunicationPreference(CommunicationCatCPCPage.post));
            });
        });
        describe('Communication class level funcitons', function () {
            it('should set setCommunicationType', function () {
                component.setCommunicationType(CommunicationCatCPCPage.email, CommunicationCatCPCPage.providedEmail);
                expect(component.communicationType).toEqual(CommunicationCatCPCPage.email);
                expect(component.emailType).toEqual(CommunicationCatCPCPage.providedEmail);
            });
            it('should return true for isProvidedEmailSelected() if appropriate properties are defined', function () {
                component.communicationType = CommunicationCatCPCPage.email;
                component.emailType = CommunicationCatCPCPage.providedEmail;
            ...
            it('should return true for isNewEmailSelected() if appropriate properties are defined', function () {
                component.communicationType = CommunicationCatCPCPage.email;
                component.emailType = CommunicationCatCPCPage.updatedEmail;
...
//# sourceMappingURL=communication.cat-cpc.page.spec.js.map