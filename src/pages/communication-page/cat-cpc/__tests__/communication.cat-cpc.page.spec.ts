...
describe('CommunicationCatCPCPage', () => {
  let fixture: ComponentFixture<CommunicationCatCPCPage>;
  let component: CommunicationCatCPCPage;
      ...
      it('should dispatch a CandidateChoseEmailAsCommunicationPreference action', () => {
        ...
        expect(store$.dispatch)
          .toHaveBeenCalledWith(new communicationPreferenceActions.CandidateChoseEmailAsCommunicationPreference(
            candidateMock.emailAddress, CommunicationCatCPCPage.email,
          ));
      });
    });
