...
var CommunicationCatCPCPageModule = /** @class */ (function () {
    function CommunicationCatCPCPageModule() {
    }
    CommunicationCatCPCPageModule = __decorate([
        NgModule({
            declarations: [
    ...
    ], CommunicationCatCPCPageModule);
    return CommunicationCatCPCPageModule;
}());
export { CommunicationCatCPCPageModule };
//# sourceMappingURL=communication.cat-cpc.page.module.js.map