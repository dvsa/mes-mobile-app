...
var CommunicationCatDPage = /** @class */ (function (_super) {
    __extends(CommunicationCatDPage, _super);
    function CommunicationCatDPage(store$, navController, platform, authenticationProvider, deviceAuthenticationProvider, translate) {
    ...
    CommunicationCatDPage_1 = CommunicationCatDPage;
    CommunicationCatDPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    CommunicationCatDPage.prototype.clickBack = function () {
        this.navController.pop();
    };
    CommunicationCatDPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    CommunicationCatDPage.prototype.ionViewWillEnter = function () {
        if (this.subscription.closed && this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    CommunicationCatDPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    CommunicationCatDPage.prototype.onSubmit = function () {
        var _this = this;
        ...
        if (this.form.valid) {
            this.deviceAuthenticationProvider.triggerLockScreen()
                ...
                _this.navController.push(CAT_D.WAITING_ROOM_TO_CAR_PAGE)
                    .then(function () {
                    var waitingRoomPage = _this.navController.getViews().find(function (view) { return view.id === CAT_D.WAITING_ROOM_PAGE; });
                    if (waitingRoomPage) {
                        _this.navController.removeView(waitingRoomPage);
                    }
                    var communicationPage = _this.navController.getViews().find(function (view) { return view.id === CAT_D.COMMUNICATION_PAGE; });
    ...
    CommunicationCatDPage.prototype.dispatchCandidateChoseProvidedEmail = function () {
        this.setCommunicationType(CommunicationCatDPage_1.email, CommunicationCatDPage_1.providedEmail);
        this.store$.dispatch(new CandidateChoseEmailAsCommunicationPreference(this.candidateProvidedEmail, CommunicationCatDPage_1.email));
    };
    CommunicationCatDPage.prototype.dispatchCandidateChoseNewEmail = function (communicationEmail) {
        this.store$.dispatch(new CandidateChoseEmailAsCommunicationPreference(communicationEmail, CommunicationCatDPage_1.email));
    };
    CommunicationCatDPage.prototype.setCommunicationType = function (communicationChoice, emailType) {
    ...
    CommunicationCatDPage.prototype.isProvidedEmailSelected = function () {
        return (this.communicationType === CommunicationCatDPage_1.email
            && this.emailType === CommunicationCatDPage_1.providedEmail);
    };
    CommunicationCatDPage.prototype.isNewEmailSelected = function () {
        return (this.communicationType === CommunicationCatDPage_1.email
            && this.emailType === CommunicationCatDPage_1.updatedEmail);
    };
    CommunicationCatDPage.prototype.isPostSelected = function () {
        return this.communicationType === CommunicationCatDPage_1.post;
    };
    CommunicationCatDPage.prototype.dispatchCandidateChosePost = function () {
        this.setCommunicationType(CommunicationCatDPage_1.post);
        this.store$.dispatch(new CandidateChosePostAsCommunicationPreference(CommunicationCatDPage_1.post));
    };
    CommunicationCatDPage.prototype.getFormValidation = function () {
        return {
     ...
     */
    CommunicationCatDPage.prototype.restoreRadiosFromState = function () {
        if (this.communicationType === CommunicationCatDPage_1.email) {
     ...
     * rehydrated.
     */
    CommunicationCatDPage.prototype.assertEmailType = function () {
    ...
    CommunicationCatDPage.prototype.restoreRadioValidators = function () {
     ...
     *
     */
    CommunicationCatDPage.prototype.initialiseDefaultSelections = function () {
        this.communicationType = CommunicationCatDPage_1.email;
    ...
    CommunicationCatDPage.prototype.verifyNewEmailFormControl = function (communicationChoice) {
        var newEmailCtrl = this.form.get('newEmailCtrl');
        if (newEmailCtrl !== null) {
            if (communicationChoice !== CommunicationCatDPage_1.email
                || this.emailType === CommunicationCatDPage_1.providedEmail) {
    ...
    CommunicationCatDPage.prototype.shouldPreselectADefaultValue = function () {
        return this.communicationType === CommunicationCatDPage_1.notProvided;
    };
    /**
     ...
     */
    CommunicationCatDPage.prototype.conditionalDispatchCandidateChoseNewEmail = function () {
        this.setCommunicationType(CommunicationCatDPage_1.email, CommunicationCatDPage_1.updatedEmail);
        if (this.isNewEmailSelected() && this.communicationEmail !== '') {
            this.dispatchCandidateChoseNewEmail(this.communicationEmail);
        }
    };
    CommunicationCatDPage.prototype.getNewEmailAddressValue = function () {
        return this.candidateProvidedEmail === this.communicationEmail ? '' : this.communicationEmail;
    };
    var CommunicationCatDPage_1;
    CommunicationCatDPage.providedEmail = 'Provided';
    CommunicationCatDPage.updatedEmail = 'Updated';
    CommunicationCatDPage.email = 'Email';
    CommunicationCatDPage.post = 'Post';
    CommunicationCatDPage.notProvided = 'Not provided';
    CommunicationCatDPage.welshLanguage = 'Cymraeg';
    CommunicationCatDPage.englishLanguage = 'English';
    __decorate([
        ViewChild(Navbar),
        __metadata("design:type", Navbar)
    ], CommunicationCatDPage.prototype, "navBar", void 0);
    CommunicationCatDPage = CommunicationCatDPage_1 = __decorate([
        IonicPage(),
        Component({
            selector: '.communication-cat-d-page',
            templateUrl: 'communication.cat-d.page.html',
        }),
    ...
    return CommunicationCatDPage;
}(BasePageComponent));
export { CommunicationCatDPage };
//# sourceMappingURL=communication.cat-d.page.js.map