...
describe('CommunicationCatADIPart2Page', function () {
    var fixture;
    var component;
    var store$;
    ...
    describe('Class', function () {
        ...
        describe('Provided email selected', function () {
            it('should dispatch a CandidateChoseEmailAsCommunicationPreference action', function () {
                ...
                expect(store$.dispatch)
                    .toHaveBeenCalledWith(new communicationPreferenceActions.CandidateChoseEmailAsCommunicationPreference(candidateMock.emailAddress, CommunicationCatADIPart2Page.email));
            });
        });
        ...
        describe('Post selected', function () {
            it('should dispatch a CandidateChosePostAsCommunicationPreference action', function () {
                ...
                expect(store$.dispatch)
                    .toHaveBeenCalledWith(new communicationPreferenceActions.CandidateChosePostAsCommunicationPreference(CommunicationCatADIPart2Page.post));
            });
        });
        describe('Communication class level funcitons', function () {
            it('should set setCommunicationType', function () {
                component.setCommunicationType(CommunicationCatADIPart2Page.email, CommunicationCatADIPart2Page.providedEmail);
                expect(component.communicationType).toEqual(CommunicationCatADIPart2Page.email);
                expect(component.emailType).toEqual(CommunicationCatADIPart2Page.providedEmail);
            });
            it('should return true for isProvidedEmailSelected() if appropriate properties are defined', function () {
                component.communicationType = CommunicationCatADIPart2Page.email;
                component.emailType = CommunicationCatADIPart2Page.providedEmail;
            ...
            it('should return true for isNewEmailSelected() if appropriate properties are defined', function () {
                component.communicationType = CommunicationCatADIPart2Page.email;
                component.emailType = CommunicationCatADIPart2Page.updatedEmail;
...
//# sourceMappingURL=communication.cat-adi-part2.page.spec.js.map