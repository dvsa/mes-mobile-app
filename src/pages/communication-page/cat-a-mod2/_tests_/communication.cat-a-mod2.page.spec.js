...
describe('CommunicationCatAMod2Page', function () {
    var fixture;
    var component;
    var store$;
    ...
    describe('Class', function () {
        ...
        describe('Provided email selected', function () {
            it('should dispatch a CandidateChoseEmailAsCommunicationPreference action', function () {
                ...
                expect(store$.dispatch)
                    .toHaveBeenCalledWith(new communicationPreferenceActions.CandidateChoseEmailAsCommunicationPreference(candidateMock.emailAddress, CommunicationCatAMod2Page.email));
            });
        });
        ...
        describe('Post selected', function () {
            it('should dispatch a CandidateChosePostAsCommunicationPreference action', function () {
                ...
                expect(store$.dispatch)
                    .toHaveBeenCalledWith(new communicationPreferenceActions.CandidateChosePostAsCommunicationPreference(CommunicationCatAMod2Page.post));
            });
        });
        describe('Communication class level funcitons', function () {
            it('should set setCommunicationType', function () {
                component.setCommunicationType(CommunicationCatAMod2Page.email, CommunicationCatAMod2Page.providedEmail);
                expect(component.communicationType).toEqual(CommunicationCatAMod2Page.email);
                expect(component.emailType).toEqual(CommunicationCatAMod2Page.providedEmail);
            });
            it('should return true for isProvidedEmailSelected() if appropriate properties are defined', function () {
                component.communicationType = CommunicationCatAMod2Page.email;
                component.emailType = CommunicationCatAMod2Page.providedEmail;
            ...
            it('should return true for isNewEmailSelected() if appropriate properties are defined', function () {
                component.communicationType = CommunicationCatAMod2Page.email;
                component.emailType = CommunicationCatAMod2Page.updatedEmail;
        ...
        describe('clickBack', function () {
            it('should not trigger the lock screen', function () {
                component.clickBack();
...
//# sourceMappingURL=communication.cat-a-mod2.page.spec.js.map