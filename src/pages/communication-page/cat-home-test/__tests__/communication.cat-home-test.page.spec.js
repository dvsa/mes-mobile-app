...
describe('CommunicationCatHomeTestPage', function () {
    var fixture;
    var component;
    var store$;
    ...
    describe('Class', function () {
        ...
        describe('Provided email selected', function () {
            it('should dispatch a CandidateChoseEmailAsCommunicationPreference action', function () {
                ...
                expect(store$.dispatch)
                    .toHaveBeenCalledWith(new communicationPreferenceActions.CandidateChoseEmailAsCommunicationPreference(candidateMock.emailAddress, CommunicationCatHomeTestPage.email));
            });
        });
        ...
        describe('Post selected', function () {
            it('should dispatch a CandidateChosePostAsCommunicationPreference action', function () {
                ...
                expect(store$.dispatch)
                    .toHaveBeenCalledWith(new communicationPreferenceActions.CandidateChosePostAsCommunicationPreference(CommunicationCatHomeTestPage.post));
            });
        });
        describe('Communication class level funcitons', function () {
            it('should set setCommunicationType', function () {
                component.setCommunicationType(CommunicationCatHomeTestPage.email, CommunicationCatHomeTestPage.providedEmail);
                expect(component.communicationType).toEqual(CommunicationCatHomeTestPage.email);
                expect(component.emailType).toEqual(CommunicationCatHomeTestPage.providedEmail);
            });
            it('should return true for isProvidedEmailSelected() if appropriate properties are defined', function () {
                component.communicationType = CommunicationCatHomeTestPage.email;
                component.emailType = CommunicationCatHomeTestPage.providedEmail;
            ...
            it('should return true for isNewEmailSelected() if appropriate properties are defined', function () {
                component.communicationType = CommunicationCatHomeTestPage.email;
                component.emailType = CommunicationCatHomeTestPage.updatedEmail;
...
//# sourceMappingURL=communication.cat-home-test.page.spec.js.map