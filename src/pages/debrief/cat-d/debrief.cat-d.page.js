...
var DebriefCatDPage = /** @class */ (function (_super) {
    __extends(DebriefCatDPage, _super);
    function DebriefCatDPage(store$, navController, navParams, platform, authenticationProvider, screenOrientation, insomnia, translate, faultCountProvider, faultSummaryProvider) {
    ...
    DebriefCatDPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    DebriefCatDPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new DebriefViewDidEnter());
    };
    DebriefCatDPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    DebriefCatDPage.prototype.endDebrief = function () {
    ...
    DebriefCatDPage = __decorate([
        IonicPage(),
        Component({
            selector: '.debrief-cat-d-page',
            templateUrl: 'debrief.cat-d.page.html',
        }),
    ...
    return DebriefCatDPage;
}(BasePageComponent));
export { DebriefCatDPage };
//# sourceMappingURL=debrief.cat-d.page.js.map