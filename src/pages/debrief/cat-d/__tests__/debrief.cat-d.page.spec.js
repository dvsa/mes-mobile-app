...
describe('DebriefCatDPage', function () {
    var fixture;
    var component;
    var navController;
    var store$;
    ...
    describe('endDebrief', function () {
        ...
        it('should navigate to PassFinalisationPage when outcome = pass', function () {
            component.outcome = TestOutcome.PASS;
            component.endDebrief();
            expect(navController.push).toHaveBeenCalledWith(CAT_D.PASS_FINALISATION_PAGE);
        });
        it('should navigate to BackToOfficePage when outcome = fail', function () {
            component.outcome = TestOutcome.FAIL;
            component.endDebrief();
            expect(navController.push).toHaveBeenCalledWith(CAT_D.POST_DEBRIEF_HOLDING_PAGE);
        });
...
//# sourceMappingURL=debrief.cat-d.page.spec.js.map