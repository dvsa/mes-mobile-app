...
describe('DebriefCatBPage', function () {
    var fixture;
    var component;
    var navController;
    var store$;
    ...
    describe('Class', function () {
        describe('ionViewDidLeave', function () {
            it('should disable the plugins when the test is a test report practice test', function () {
                component.isTestReportPracticeMode = true;
                component.ionViewDidLeave();
                expect(screenOrientation.unlock).toHaveBeenCalled();
                expect(insomnia.allowSleepAgain).toHaveBeenCalled();
            });
            it('should not disable the plugins when the test is not a test report practice test', function () {
    ...
    describe('DOM', function () {
        ...
        describe('endDebrief', function () {
            ...
            it('should navigate back to the root when this is a test report practice test', function () {
                component.isTestReportPracticeMode = true;
                component.endDebrief();
...
//# sourceMappingURL=debrief.cat-b.page.spec.js.map