...
var DebriefCatHomeTestPageModule = /** @class */ (function () {
    function DebriefCatHomeTestPageModule() {
    }
    DebriefCatHomeTestPageModule = __decorate([
        NgModule({
            declarations: [
    ...
    ], DebriefCatHomeTestPageModule);
    return DebriefCatHomeTestPageModule;
}());
export { DebriefCatHomeTestPageModule };
//# sourceMappingURL=debrief.cat-home-test.page.module.js.map