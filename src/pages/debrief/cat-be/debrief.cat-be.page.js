...
var DebriefCatBEPage = /** @class */ (function (_super) {
    __extends(DebriefCatBEPage, _super);
    function DebriefCatBEPage(store$, navController, navParams, platform, authenticationProvider, screenOrientation, insomnia, translate, faultCountProvider, faultSummaryProvider) {
    ...
    DebriefCatBEPage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.pageState = {
            seriousFaults$: currentTest$.pipe(select(getTestData), map(function (data) {
                return _this.faultSummaryProvider.getSeriousFaultsList(data, "B+E" /* BE */)
            ...
            dangerousFaults$: currentTest$.pipe(select(getTestData), map(function (data) {
                return _this.faultSummaryProvider.getDangerousFaultsList(data, "B+E" /* BE */)
                    .map(function (fault) { return fault.competencyIdentifier; });
            })),
    ...
    DebriefCatBEPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new DebriefViewDidEnter());
    };
    DebriefCatBEPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    DebriefCatBEPage.prototype.endDebrief = function () {
    ...
    return DebriefCatBEPage;
}(BasePageComponent));
export { DebriefCatBEPage };
//# sourceMappingURL=debrief.cat-be.page.js.map