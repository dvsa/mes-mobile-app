...
var DebriefCatBEPageModule = /** @class */ (function () {
    function DebriefCatBEPageModule() {
    }
    DebriefCatBEPageModule = __decorate([
        NgModule({
            declarations: [
                DebriefCatBEPage,
            ],
    ...
    return DebriefCatBEPageModule;
}());
export { DebriefCatBEPageModule };
//# sourceMappingURL=debrief.cat-be.page.module.js.map