...
import { of } from 'rxjs';
import { SafetyAndBalanceCardCatAMod2Component, } from '../components/safety-and-balance-card/safety-and-balance-card.cat-a-mod2';
import { TestOutcome } from '../../../../shared/models/test-outcome';
import { configureTestSuite } from 'ng-bullet';
describe('DebriefCatAMod2Page', function () {
    var fixture;
    var component;
    var navController;
    var store$;
    ...
    it('should display driving faults container if there are riding faults', function () {
    ...
    describe('endDebrief', function () {
        ...
        it('should navigate to PassFinalisationPage when outcome = pass', function () {
            component.outcome = TestOutcome.PASS;
            component.endDebrief();
            expect(navController.push).toHaveBeenCalledWith(CAT_A_MOD2.PASS_FINALISATION_PAGE);
        });
        it('should navigate to BackToOfficePage when outcome = fail', function () {
            component.outcome = TestOutcome.FAIL;
            component.endDebrief();
            expect(navController.push).toHaveBeenCalledWith(CAT_A_MOD2.POST_DEBRIEF_HOLDING_PAGE);
        });
...
//# sourceMappingURL=debrief.cat-a-mod2.page.spec.js.map