...
describe('DebriefCatADIPart2Page', function () {
    var fixture;
    var component;
    var navController;
    var store$;
    ...
    describe('endDebrief', function () {
        ...
        it('should navigate to PostDebriefHoldingPage when outcome = fail', function () {
            component.outcome = TestOutcome.FAIL;
            component.endDebrief();
            expect(navController.push).toHaveBeenCalledWith(CAT_ADI_PART2.POST_DEBRIEF_HOLDING_PAGE);
        });
        it('should navigate to the PostDebriefHoldingPage when outcomes = terminated', function () {
            component.outcome = 'Terminated';
            component.endDebrief();
            expect(navController.push).toHaveBeenCalledWith(CAT_ADI_PART2.POST_DEBRIEF_HOLDING_PAGE);
        });
...
//# sourceMappingURL=debrief.cat-adi-part2.page.spec.js.map