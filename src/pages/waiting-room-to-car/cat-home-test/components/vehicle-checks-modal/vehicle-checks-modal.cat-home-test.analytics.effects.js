...
import { VEHICLE_CHECKS_VIEW_DID_ENTER, } from './vehicle-checks-modal.cat-home-test.actions';
...
import { SHOW_ME_QUESTION_OUTCOME_CHANGED, SHOW_ME_QUESTION_SELECTED, TELL_ME_QUESTION_OUTCOME_CHANGED, TELL_ME_QUESTION_SELECTED, } from '../../../../../modules/tests/test-data/cat-home-test/vehicle-checks/vehicle-checks.cat-home-test.action';
var VehicleChecksModalAnalyticsEffects = /** @class */ (function () {
    function VehicleChecksModalAnalyticsEffects(analytics, actions$, store$) {
        var _this = this;
    ...
    ], VehicleChecksModalAnalyticsEffects.prototype, "vehicleChecksModalViewDidEnter$", void 0);
    __decorate([
        Effect(),
        __metadata("design:type", Object)
    ], VehicleChecksModalAnalyticsEffects.prototype, "showMeQuestionChanged$", void 0);
    __decorate([
        Effect(),
        __metadata("design:type", Object)
    ], VehicleChecksModalAnalyticsEffects.prototype, "showMeQuestionOutComeChanged$", void 0);
    __decorate([
        Effect(),
        __metadata("design:type", Object)
    ], VehicleChecksModalAnalyticsEffects.prototype, "tellMeQuestionChanged$", void 0);
    __decorate([
        Effect(),
        __metadata("design:type", Object)
    ], VehicleChecksModalAnalyticsEffects.prototype, "tellMeQuestionOutComeChanged$", void 0);
    VehicleChecksModalAnalyticsEffects = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [AnalyticsProvider,
            Actions,
            Store])
    ], VehicleChecksModalAnalyticsEffects);
    return VehicleChecksModalAnalyticsEffects;
}());
export { VehicleChecksModalAnalyticsEffects };
//# sourceMappingURL=vehicle-checks-modal.cat-home-test.analytics.effects.js.map