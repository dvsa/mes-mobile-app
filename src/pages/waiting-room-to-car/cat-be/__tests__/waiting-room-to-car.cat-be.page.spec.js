...
import { VehicleChecksCompletedToggled, } from '../../../../modules/tests/test-data/cat-be/vehicle-checks/vehicle-checks.cat-be.action';
...
describe('WaitingRoomToCarCatBEPage', function () {
    var fixture;
    var component;
    var store$;
    ...
    describe('DOM', function () {
        describe('eyesight failure confirmation', function () {
            ...
            it('should show the is load secure warning banner', function () {
                fixture.detectChanges();
                var warningBanner = fixture.debugElement.query(By.css('warning-banner'));
...
//# sourceMappingURL=waiting-room-to-car.cat-be.page.spec.js.map