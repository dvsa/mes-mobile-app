...
import * as VehicleChecksActions from '../../../../../../modules/tests/test-data/cat-be/vehicle-checks/vehicle-checks.cat-be.action';
...
describe('Vehicle Checks Modal Analytics Effects', function () {
    ...
    describe('vehicleChecksModalViewDidEnter$ effect', function () {
        it('should call analytics.setCurrentPage', function (done) {
            store$.dispatch(new testsActions.StartTest(12345, "B+E" /* BE */));
...
//# sourceMappingURL=vehicle-checks-modal.cat-be.analytics.effects.spec.js.map