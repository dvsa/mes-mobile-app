...
describe('VehicleChecksCatBEComponent', function () {
    var fixture;
    var component;
    var modalController;
    ...
    describe('Class', function () {
        describe('openVehicleChecksModal', function () {
            it('should create the correct model', function () {
                ...
                expect(modalController.create).toHaveBeenCalledWith(CAT_ADI_PART2.VEHICLE_CHECKS_MODAL, {}, { cssClass: 'modal-fullscreen text-zoom-regular' });
            });
        });
        ...
        describe('everyQuestionHasOutcome', function () {
            ...
            it('should return true when all tell me questions have outcome', function () {
                component.vehicleChecks = {
...
//# sourceMappingURL=vehicle-checks.cat-adi-part2.spec.js.map