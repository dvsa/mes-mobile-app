...
import { VehicleChecksQuestionCatDComponent } from '../vehicle-checks-question.cat-d';
...
describe('VehicleChecksQuestionComponent', () => {
  let fixture: ComponentFixture<VehicleChecksQuestionCatDComponent>;
  let component: VehicleChecksQuestionCatDComponent;
  ...
  beforeEach(async(() => {
    fixture = TestBed.createComponent(VehicleChecksQuestionCatDComponent);
