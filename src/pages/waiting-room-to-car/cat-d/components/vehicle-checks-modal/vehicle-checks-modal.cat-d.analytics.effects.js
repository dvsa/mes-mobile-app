...
import { VEHICLE_CHECKS_VIEW_DID_ENTER, } from './vehicle-checks-modal.cat-d.actions';
...
import { SHOW_ME_QUESTION_OUTCOME_CHANGED, SHOW_ME_QUESTION_SELECTED, TELL_ME_QUESTION_OUTCOME_CHANGED, TELL_ME_QUESTION_SELECTED, } from '../../../../../modules/tests/test-data/cat-d/vehicle-checks/vehicle-checks.cat-d.action';
import { SAFETY_QUESTION_OUTCOME_CHANGED, } from '../../../../../modules/tests/test-data/cat-d/safety-questions/safety-questions.cat-d.action';
var VehicleChecksModalCatDAnalyticsEffects = /** @class */ (function () {
    function VehicleChecksModalCatDAnalyticsEffects(analytics, actions$, store$) {
        var _this = this;
    ...
    ], VehicleChecksModalCatDAnalyticsEffects.prototype, "vehicleChecksModalViewDidEnter$", void 0);
    __decorate([
        Effect(),
        __metadata("design:type", Object)
    ], VehicleChecksModalCatDAnalyticsEffects.prototype, "showMeQuestionChanged$", void 0);
    __decorate([
        Effect(),
        __metadata("design:type", Object)
    ], VehicleChecksModalCatDAnalyticsEffects.prototype, "showMeQuestionOutComeChanged$", void 0);
    __decorate([
        Effect(),
        __metadata("design:type", Object)
    ], VehicleChecksModalCatDAnalyticsEffects.prototype, "tellMeQuestionChanged$", void 0);
    __decorate([
        Effect(),
        __metadata("design:type", Object)
    ], VehicleChecksModalCatDAnalyticsEffects.prototype, "tellMeQuestionOutComeChanged$", void 0);
    __decorate([
        Effect(),
        __metadata("design:type", Object)
    ], VehicleChecksModalCatDAnalyticsEffects.prototype, "safetyQuestionOutcomeChanged$", void 0);
    VehicleChecksModalCatDAnalyticsEffects = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [AnalyticsProvider,
            Actions,
            Store])
    ], VehicleChecksModalCatDAnalyticsEffects);
    return VehicleChecksModalCatDAnalyticsEffects;
}());
export { VehicleChecksModalCatDAnalyticsEffects };
//# sourceMappingURL=vehicle-checks-modal.cat-d.analytics.effects.js.map