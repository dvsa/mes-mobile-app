...
import * as VehicleChecksActions from '../../../../../../modules/tests/test-data/cat-c/vehicle-checks/vehicle-checks.cat-c.action';
import { configureTestSuite } from 'ng-bullet';
describe('Vehicle Checks Modal Cat C Analytics Effects', function () {
    var effects;
    ...
    describe('vehicleChecksModalViewDidEnter$ effect', function () {
        it('should call analytics.setCurrentPage', function (done) {
            store$.dispatch(new testsActions.StartTest(12345, "C" /* C */));
...
//# sourceMappingURL=vehicle-checks-modal.cat-c.analytics.effects.spec.js.map