...
var BackToOfficeCatBPage = /** @class */ (function (_super) {
    __extends(BackToOfficeCatBPage, _super);
    function BackToOfficeCatBPage(store$, deviceProvider, navController, navParams, platform, authenticationProvider, screenOrientation, insomnia) {
    ...
    BackToOfficeCatBPage.prototype.goToJournal = function () {
        if (this.isPracticeMode) {
    ...
    BackToOfficeCatBPage.prototype.goToOfficePage = function () {
        this.navController.push(CAT_B.OFFICE_PAGE);
    };
    BackToOfficeCatBPage = __decorate([
        IonicPage(),
        Component({
    ...
    return BackToOfficeCatBPage;
}(PracticeableBasePageComponent));
export { BackToOfficeCatBPage };
//# sourceMappingURL=back-to-office.cat-b.page.js.map