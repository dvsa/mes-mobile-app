...
var BackToOfficeCatDPage = /** @class */ (function (_super) {
    __extends(BackToOfficeCatDPage, _super);
    function BackToOfficeCatDPage(store$, navController, navParams, platform, authenticationProvider, screenOrientation, insomnia, deviceProvider) {
    ...
    BackToOfficeCatDPage.prototype.ngOnInit = function () {
        this.pageState = {
            isRekey$: this.store$.pipe(select(getTests), select(getCurrentTest), select(getRekeyIndicator), select(isRekey)),
        };
    };
    BackToOfficeCatDPage.prototype.ionViewDidEnter = function () {
    ...
    BackToOfficeCatDPage.prototype.goToJournal = function () {
    ...
    BackToOfficeCatDPage.prototype.goToOfficePage = function () {
        this.navController.push(CAT_D.OFFICE_PAGE);
    };
    BackToOfficeCatDPage = __decorate([
        IonicPage(),
        Component({
    ...
    return BackToOfficeCatDPage;
}(BasePageComponent));
export { BackToOfficeCatDPage };
//# sourceMappingURL=back-to-office.cat-d.page.js.map