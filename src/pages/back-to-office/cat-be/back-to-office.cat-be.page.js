...
var BackToOfficeCatBEPage = /** @class */ (function (_super) {
    __extends(BackToOfficeCatBEPage, _super);
    function BackToOfficeCatBEPage(store$, navController, navParams, platform, authenticationProvider, screenOrientation, insomnia, deviceProvider) {
    ...
    BackToOfficeCatBEPage.prototype.ngOnInit = function () {
        this.pageState = {
            isRekey$: this.store$.pipe(select(getTests), select(getCurrentTest), select(getRekeyIndicator), select(isRekey)),
        };
    };
    BackToOfficeCatBEPage.prototype.ionViewDidEnter = function () {
    ...
    BackToOfficeCatBEPage.prototype.goToJournal = function () {
    ...
    BackToOfficeCatBEPage.prototype.goToOfficePage = function () {
        this.navController.push(CAT_BE.OFFICE_PAGE);
    };
    BackToOfficeCatBEPage = __decorate([
        IonicPage(),
        Component({
    ...
    return BackToOfficeCatBEPage;
}(BasePageComponent));
export { BackToOfficeCatBEPage };
//# sourceMappingURL=back-to-office.cat-be.page.js.map