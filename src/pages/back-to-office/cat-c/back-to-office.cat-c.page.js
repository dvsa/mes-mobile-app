...
var BackToOfficeCatCPage = /** @class */ (function (_super) {
    __extends(BackToOfficeCatCPage, _super);
    function BackToOfficeCatCPage(store$, navController, navParams, platform, authenticationProvider, screenOrientation, insomnia, deviceProvider) {
    ...
    BackToOfficeCatCPage.prototype.ngOnInit = function () {
        this.pageState = {
            isRekey$: this.store$.pipe(select(getTests), select(getCurrentTest), select(getRekeyIndicator), select(isRekey)),
        };
    };
    BackToOfficeCatCPage.prototype.ionViewDidEnter = function () {
    ...
    BackToOfficeCatCPage.prototype.goToJournal = function () {
    ...
    BackToOfficeCatCPage.prototype.goToOfficePage = function () {
        this.navController.push(CAT_C.OFFICE_PAGE);
    };
    BackToOfficeCatCPage = __decorate([
        IonicPage(),
        Component({
    ...
    return BackToOfficeCatCPage;
}(BasePageComponent));
export { BackToOfficeCatCPage };
//# sourceMappingURL=back-to-office.cat-c.page.js.map