...
describe('BackToOfficeCatHomeTestPage', () => {
  let fixture: ComponentFixture<BackToOfficeCatHomeTestPage>;
  let component: BackToOfficeCatHomeTestPage;
  ...
  beforeEach(async(() => {
    fixture = TestBed.createComponent(BackToOfficeCatHomeTestPage);
