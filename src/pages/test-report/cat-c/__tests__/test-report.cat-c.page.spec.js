...
describe('TestReportCatCPage', function () {
    var fixture;
    var component;
    var navController;
    ...
    describe('showUncoupleRecouple', function () {
        it('should return false when the test is a category C', function () {
            component.testCategory = "C" /* C */;
            expect(component.showUncoupleRecouple()).toBeFalsy();
        });
        it('should return false when the test is a category C1', function () {
            component.testCategory = "C1" /* C1 */;
            expect(component.showUncoupleRecouple()).toBeFalsy();
        });
        it('should return true when the test is a category C1E', function () {
            component.testCategory = "C1+E" /* C1E */;
            expect(component.showUncoupleRecouple()).toBeTruthy();
        });
        it('should return true when the test is a category CE', function () {
            component.testCategory = "C+E" /* CE */;
            expect(component.showUncoupleRecouple()).toBeTruthy();
        });
    });
});
//# sourceMappingURL=test-report.cat-c.page.spec.js.map