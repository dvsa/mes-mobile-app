...
describe('MultiLegalRequirementComponent', function () {
    var fixture;
    var component;
    var store$;
    ...
    describe('Class', function () {
        it('should dispatch a TOGGLE_NORMAL_START_1 action if neither requirement is ticked', function () {
        ...
        it('should dispatch a TOGGLE_NORMAL_START_2 action if requirement1 ticked is true', function () {
            component.legalRequirement1 = LegalRequirements.normalStart1;
    ...
    it('should toggle both Normal start 1 and Normal start 2 if both requirements are ticked', function () {
        component.legalRequirement1 = LegalRequirements.normalStart1;
        component.requirement1Ticked = true;
        component.legalRequirement2 = LegalRequirements.normalStart2;
    ...
    it('should dispatch a TOGGLE_BUS_STOP_1 action if neither requirement is ticked', function () {
    ...
    it('should dispatch a TOGGLE_BUS_STOP_2 action if requirement1 ticked is true', function () {
        component.legalRequirement1 = LegalRequirements.busStop1;
        component.requirement1Ticked = true;
        component.legalRequirement2 = LegalRequirements.busStop2;
        component.requirement2Ticked = false;
    ...
    it('should toggle both bus stop 1 and bus stop 2 if both requirements are ticked', function () {
        component.legalRequirement1 = LegalRequirements.busStop1;
        component.requirement1Ticked = true;
        component.legalRequirement2 = LegalRequirements.busStop2;
        component.requirement2Ticked = true;
...
//# sourceMappingURL=multi-legal-requirement.spec.js.map