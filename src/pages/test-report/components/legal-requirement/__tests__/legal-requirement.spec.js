...
describe('LegalRequirementComponent', function () {
    var fixture;
    var component;
    var store$;
    ...
    describe('Class', function () {
        it('should dispatch a TOGGLE_NORMAL_START_1 action', function () {
        ...
        it('should dispatch a TOGGLE_NORMAL_START_2 action', function () {
        ...
        it('should dispatch a TOGGLE_ANGLED_START action', function () {
        ...
        it('should dispatch a TOGGLE_HILL_START action', function () {
    ...
    describe('getLegalRequirementClass', function () {
        it('should return \'normal-start-class\' if component.legalRequirement value contains \'normalStart\'', function () {
            component.legalRequirement = LegalRequirements.normalStart1;
            expect(component.getLegalRequirementClass()).toEqual('normal-start-label');
        });
        it('should return \'label\' if component.legalRequirement value does not contain \'normalStart\'', function () {
            component.legalRequirement = LegalRequirements.uphillStart;
            expect(component.getLegalRequirementClass()).toEqual('label');
        });
    });
});
//# sourceMappingURL=legal-requirement.spec.js.map