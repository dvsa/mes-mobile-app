...
} from '../../../../modules/tests/test-data/common/highway-code-safety/highway-code-safety.selectors';
...
export class HighwayCodeSafetyComponent implements OnInit, OnDestroy {
  ...
  toggleHighwayCodeSafety = (): void => {
    ...
    this.store$.dispatch(new highwayCodeSafetyAction.ToggleHighwayCodeSafety());
  }
  ...
  addFault = (wasPress: boolean): void => {
    ...
    if (this.isSeriousMode) {
      this.store$.dispatch(new highwayCodeSafetyAction.HighwayCodeSafetyAddSeriousFault());
      this.store$.dispatch(new ToggleSeriousFaultMode());
      return;
    }

    if (wasPress) {
      this.store$.dispatch(new highwayCodeSafetyAction.HighwayCodeSafetyAddDrivingFault());
    }
  }
  ...
  removeFault = (): void => {
    ...
    if (this.hasSeriousFault() && this.isSeriousMode && this.isRemoveFaultMode) {
      this.store$.dispatch(new highwayCodeSafetyAction.HighwayCodeSafetyRemoveFault());
      this.store$.dispatch(new ToggleSeriousFaultMode());
