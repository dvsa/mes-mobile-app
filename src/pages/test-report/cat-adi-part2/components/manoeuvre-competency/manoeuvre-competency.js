...
import { AddManoeuvreDrivingFault, AddManoeuvreSeriousFault, AddManoeuvreDangerousFault, RemoveManoeuvreFault, } from '../../../../../modules/tests/test-data/cat-adi-part2/manoeuvres/manoeuvres.actions';
...
var ManoeuvreCompetencyComponentAdiPart2 = /** @class */ (function () {
    function ManoeuvreCompetencyComponentAdiPart2(store$) {
        var _this = this;
        this.store$ = store$;
        ...
        this.addFault = function (wasPress) {
            ...
            if (_this.isDangerousMode) {
                _this.store$.dispatch(new AddManoeuvreDangerousFault(payload, _this.index));
                _this.store$.dispatch(new ToggleDangerousFaultMode());
                return;
            }
            if (_this.isSeriousMode) {
                _this.store$.dispatch(new AddManoeuvreSeriousFault(payload, _this.index));
                _this.store$.dispatch(new ToggleSeriousFaultMode());
                return;
            }
            if (wasPress) {
                _this.store$.dispatch(new AddManoeuvreDrivingFault(payload, _this.index));
                return;
            }
        };
        this.removeFault = function () {
            ...
            if (_this.hasDangerousFault() && _this.isDangerousMode && _this.isRemoveFaultMode) {
                _this.store$.dispatch(new RemoveManoeuvreFault(payload, _this.index));
                _this.store$.dispatch(new ToggleDangerousFaultMode());
                _this.store$.dispatch(new ToggleRemoveFaultMode());
                return;
            }
    ...
    ManoeuvreCompetencyComponentAdiPart2.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.componentState = {
            ...
            manoeuvreCompetencyOutcome$: currentTest$.pipe(select(getTestData), select(getManoeuvresADI2), map(function (manoeuvres) { return manoeuvres[_this.index]; }), select(function (manoeuvres) {
                if (manoeuvres) {
        ...
        var _a = this.componentState, isRemoveFaultMode$ = _a.isRemoveFaultMode$, isSeriousMode$ = _a.isSeriousMode$, isDangerousMode$ = _a.isDangerousMode$, manoeuvreCompetencyOutcome$ = _a.manoeuvreCompetencyOutcome$;
        var merged$ = merge(isRemoveFaultMode$.pipe(map(function (toggle) { return _this.isRemoveFaultMode = toggle; })), isSeriousMode$.pipe(map(function (toggle) { return _this.isSeriousMode = toggle; })), isDangerousMode$.pipe(map(function (toggle) { return _this.isDangerousMode = toggle; })), manoeuvreCompetencyOutcome$.pipe(map(function (outcome) { return _this.manoeuvreCompetencyOutcome = outcome; })));
        this.subscription = merged$.subscribe();
    };
    ManoeuvreCompetencyComponentAdiPart2.prototype.ngOnDestroy = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    ManoeuvreCompetencyComponentAdiPart2.prototype.onTouchStart = function () {
        clearTimeout(this.touchTimeout);
        this.touchState = true;
    };
    ManoeuvreCompetencyComponentAdiPart2.prototype.onTouchEnd = function () {
        var _this = this;
    ...
    ], ManoeuvreCompetencyComponentAdiPart2.prototype, "competency", void 0);
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], ManoeuvreCompetencyComponentAdiPart2.prototype, "manoeuvre", void 0);
    __decorate([
        Input(),
        __metadata("design:type", Number)
    ], ManoeuvreCompetencyComponentAdiPart2.prototype, "index", void 0);
    ManoeuvreCompetencyComponentAdiPart2 = __decorate([
        Component({
    ...
    return ManoeuvreCompetencyComponentAdiPart2;
}());
export { ManoeuvreCompetencyComponentAdiPart2 };
