...
describe('ManoeuvresComponent', function () {
    var fixture;
    var component;
    ...
    describe('DOM', function () {
        describe('Button', function () {
            it('should show provided label', function () {
                ...
                var label = fixture.debugElement.query(By.css('.label'));
                expect(label.nativeElement.innerHTML).toBe('a label');
            });
        });
        describe('Button', function () {
            it('should display popover type control content when displayPopover is true', function () {
                component.displayPopover = true;
                fixture.detectChanges();
                var tickDe = fixture.debugElement.query(By.css('.popover'));
                expect(tickDe).toBeDefined();
            });
        });
    });
});
//# sourceMappingURL=manoeuvres.spec.js.map