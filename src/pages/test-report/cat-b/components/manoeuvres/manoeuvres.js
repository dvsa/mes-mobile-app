...
var ManoeuvresComponent = /** @class */ (function () {
    ...
    ManoeuvresComponent.prototype.ngOnInit = function () {
        ...
        this.subscription = this.manoeuvres$.subscribe(function (manoeuvres) {
            _this.drivingFaults =
                _this.faultCountProvider.getManoeuvreFaultCount("B" /* B */, manoeuvres, CompetencyOutcome.DF);
            _this.hasSeriousFault =
                _this.faultCountProvider.getManoeuvreFaultCount("B" /* B */, manoeuvres, CompetencyOutcome.S) > 0;
            _this.hasDangerousFault =
                _this.faultCountProvider.getManoeuvreFaultCount("B" /* B */, manoeuvres, CompetencyOutcome.D) > 0;
        });
    };
