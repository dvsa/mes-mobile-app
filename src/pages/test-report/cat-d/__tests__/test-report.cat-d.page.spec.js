...
import { VehicleChecksCompactCatDComponent, } from '../components/vehicle-checks-compact/vehicle-checks-compact.cat-d';
...
describe('TestReportCatDPage', function () {
    var fixture;
    var component;
    var navController;
    ...
    describe('showUncoupleRecouple', function () {
        it('should return false when the test is a category D', function () {
            component.testCategory = "D" /* D */;
            expect(component.showUncoupleRecouple()).toBeFalsy();
        });
        it('should return false when the test is a category D1', function () {
            component.testCategory = "D1" /* D1 */;
            expect(component.showUncoupleRecouple()).toBeFalsy();
        });
        it('should return true when the test is a category D1E', function () {
            component.testCategory = "D1+E" /* D1E */;
            expect(component.showUncoupleRecouple()).toBeTruthy();
        });
        it('should return true when the test is a category DE', function () {
            component.testCategory = "D+E" /* DE */;
            expect(component.showUncoupleRecouple()).toBeTruthy();
        });
    });
});
//# sourceMappingURL=test-report.cat-d.page.spec.js.map