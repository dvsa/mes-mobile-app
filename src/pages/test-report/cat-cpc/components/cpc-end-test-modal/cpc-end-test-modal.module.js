...
var CPCEndTestModalModule = /** @class */ (function () {
    function CPCEndTestModalModule() {
    }
    CPCEndTestModalModule = __decorate([
        NgModule({
            declarations: [
                CPCEndTestModal,
    ...
    return CPCEndTestModalModule;
}());
export { CPCEndTestModalModule };
//# sourceMappingURL=cpc-end-test-modal.module.js.map