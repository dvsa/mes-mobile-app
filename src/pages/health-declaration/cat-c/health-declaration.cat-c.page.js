...
var HealthDeclarationCatCPage = /** @class */ (function (_super) {
    __extends(HealthDeclarationCatCPage, _super);
    function HealthDeclarationCatCPage(store$, navController, navParams, platform, authenticationProvider, deviceAuthenticationProvider, translate, alertController) {
    ...
    HealthDeclarationCatCPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    HealthDeclarationCatCPage.prototype.clickBack = function () {
        var _this = this;
    ...
    HealthDeclarationCatCPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    HealthDeclarationCatCPage.prototype.ionViewWillEnter = function () {
        if (this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    HealthDeclarationCatCPage.prototype.getSignatureDrawCompleteAction = function () {
        return postTestDeclarationsActions.SIGNATURE_DATA_CHANGED;
    };
    HealthDeclarationCatCPage.prototype.getSignatureClearAction = function () {
        return postTestDeclarationsActions.SIGNATURE_DATA_CLEARED;
    };
    HealthDeclarationCatCPage.prototype.healthDeclarationChanged = function () {
        this.store$.dispatch(new postTestDeclarationsActions.ToggleHealthDeclaration());
    };
    HealthDeclarationCatCPage.prototype.receiptDeclarationChanged = function () {
        this.store$.dispatch(new postTestDeclarationsActions.ToggleReceiptDeclaration());
    };
    HealthDeclarationCatCPage.prototype.onSubmit = function () {
        var _this = this;
    ...
    HealthDeclarationCatCPage.prototype.showConfirmHealthDeclarationModal = function () {
        var _this = this;
    ...
    HealthDeclarationCatCPage.prototype.persistAndNavigate = function (resetLicenseProvided) {
        var _this = this;
        this.deviceAuthenticationProvider.triggerLockScreen()
            .then(function () {
    ...
    HealthDeclarationCatCPage.prototype.ionViewDidLeave = function () {
    ...
    ], HealthDeclarationCatCPage.prototype, "navBar", void 0);
    HealthDeclarationCatCPage = __decorate([
        IonicPage(),
        Component({
            selector: '.health-declaration-cat-c-page',
            templateUrl: 'health-declaration.cat-c.page.html',
        }),
    ...
    return HealthDeclarationCatCPage;
}(BasePageComponent));
export { HealthDeclarationCatCPage };
//# sourceMappingURL=health-declaration.cat-c.page.js.map