...
var HealthDeclarationCatAMod2Page = /** @class */ (function (_super) {
    __extends(HealthDeclarationCatAMod2Page, _super);
    function HealthDeclarationCatAMod2Page(store$, navController, navParams, platform, authenticationProvider, deviceAuthenticationProvider, translate, alertController) {
    ...
    HealthDeclarationCatAMod2Page.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    HealthDeclarationCatAMod2Page.prototype.clickBack = function () {
        var _this = this;
    ...
    HealthDeclarationCatAMod2Page.prototype.ngOnInit = function () {
        var _this = this;
    ...
    HealthDeclarationCatAMod2Page.prototype.ionViewWillEnter = function () {
        if (this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    HealthDeclarationCatAMod2Page.prototype.getSignatureDrawCompleteAction = function () {
        return postTestDeclarationsActions.SIGNATURE_DATA_CHANGED;
    };
    HealthDeclarationCatAMod2Page.prototype.getSignatureClearAction = function () {
        return postTestDeclarationsActions.SIGNATURE_DATA_CLEARED;
    };
    HealthDeclarationCatAMod2Page.prototype.healthDeclarationChanged = function () {
        this.store$.dispatch(new postTestDeclarationsActions.ToggleHealthDeclaration());
    };
    HealthDeclarationCatAMod2Page.prototype.receiptDeclarationChanged = function () {
        this.store$.dispatch(new postTestDeclarationsActions.ToggleReceiptDeclaration());
    };
    HealthDeclarationCatAMod2Page.prototype.onSubmit = function () {
        var _this = this;
    ...
    HealthDeclarationCatAMod2Page.prototype.showConfirmHealthDeclarationModal = function () {
        var _this = this;
    ...
    HealthDeclarationCatAMod2Page.prototype.persistAndNavigate = function (resetLicenseProvided) {
        var _this = this;
        this.deviceAuthenticationProvider.triggerLockScreen()
            .then(function () {
    ...
    HealthDeclarationCatAMod2Page.prototype.ionViewDidLeave = function () {
    ...
    ], HealthDeclarationCatAMod2Page.prototype, "navBar", void 0);
    HealthDeclarationCatAMod2Page = __decorate([
        IonicPage(),
        Component({
            selector: '.health-declaration-cat-a-mod2-page',
            templateUrl: 'health-declaration.cat-a-mod2.page.html',
        }),
    ...
    return HealthDeclarationCatAMod2Page;
}(BasePageComponent));
export { HealthDeclarationCatAMod2Page };
//# sourceMappingURL=health-declaration.cat-a-mod2.page.js.map