...
var HealthDeclarationCatCpcPageModule = /** @class */ (function () {
    function HealthDeclarationCatCpcPageModule() {
    }
    HealthDeclarationCatCpcPageModule = __decorate([
        NgModule({
            declarations: [
    ...
    return HealthDeclarationCatCpcPageModule;
}());
export { HealthDeclarationCatCpcPageModule };
//# sourceMappingURL=health-declaration.cat-cpc.page.module.js.map