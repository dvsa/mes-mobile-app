...
var HealthDeclarationCatAMod1Page = /** @class */ (function (_super) {
    __extends(HealthDeclarationCatAMod1Page, _super);
    function HealthDeclarationCatAMod1Page(store$, navController, navParams, platform, authenticationProvider, deviceAuthenticationProvider, translate, alertController) {
    ...
    HealthDeclarationCatAMod1Page.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    HealthDeclarationCatAMod1Page.prototype.clickBack = function () {
        var _this = this;
    ...
    HealthDeclarationCatAMod1Page.prototype.ngOnInit = function () {
        var _this = this;
    ...
    HealthDeclarationCatAMod1Page.prototype.ionViewWillEnter = function () {
        if (this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    HealthDeclarationCatAMod1Page.prototype.getSignatureDrawCompleteAction = function () {
        return postTestDeclarationsActions.SIGNATURE_DATA_CHANGED;
    };
    HealthDeclarationCatAMod1Page.prototype.getSignatureClearAction = function () {
        return postTestDeclarationsActions.SIGNATURE_DATA_CLEARED;
    };
    HealthDeclarationCatAMod1Page.prototype.healthDeclarationChanged = function () {
        this.store$.dispatch(new postTestDeclarationsActions.ToggleHealthDeclaration());
    };
    HealthDeclarationCatAMod1Page.prototype.receiptDeclarationChanged = function () {
        this.store$.dispatch(new postTestDeclarationsActions.ToggleReceiptDeclaration());
    };
    HealthDeclarationCatAMod1Page.prototype.onSubmit = function () {
        var _this = this;
    ...
    HealthDeclarationCatAMod1Page.prototype.showConfirmHealthDeclarationModal = function () {
        var _this = this;
    ...
    HealthDeclarationCatAMod1Page.prototype.persistAndNavigate = function (resetLicenseProvided) {
        var _this = this;
        this.deviceAuthenticationProvider.triggerLockScreen()
            .then(function () {
    ...
    HealthDeclarationCatAMod1Page.prototype.ionViewDidLeave = function () {
    ...
    ], HealthDeclarationCatAMod1Page.prototype, "navBar", void 0);
    HealthDeclarationCatAMod1Page = __decorate([
        IonicPage(),
        Component({
    ...
    return HealthDeclarationCatAMod1Page;
}(BasePageComponent));
export { HealthDeclarationCatAMod1Page };
//# sourceMappingURL=health-declaration.cat-a-mod1.page.js.map