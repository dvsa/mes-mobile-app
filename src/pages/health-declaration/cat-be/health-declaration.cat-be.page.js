...
var HealthDeclarationCatBEPage = /** @class */ (function (_super) {
    __extends(HealthDeclarationCatBEPage, _super);
    function HealthDeclarationCatBEPage(store$, navController, navParams, platform, authenticationProvider, deviceAuthenticationProvider, translate, alertController) {
    ...
    HealthDeclarationCatBEPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    HealthDeclarationCatBEPage.prototype.clickBack = function () {
        var _this = this;
    ...
    HealthDeclarationCatBEPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    HealthDeclarationCatBEPage.prototype.ionViewWillEnter = function () {
        if (this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    HealthDeclarationCatBEPage.prototype.getSignatureDrawCompleteAction = function () {
        return postTestDeclarationsActions.SIGNATURE_DATA_CHANGED;
    };
    HealthDeclarationCatBEPage.prototype.getSignatureClearAction = function () {
        return postTestDeclarationsActions.SIGNATURE_DATA_CLEARED;
    };
    HealthDeclarationCatBEPage.prototype.healthDeclarationChanged = function () {
        this.store$.dispatch(new postTestDeclarationsActions.ToggleHealthDeclaration());
    };
    HealthDeclarationCatBEPage.prototype.receiptDeclarationChanged = function () {
        this.store$.dispatch(new postTestDeclarationsActions.ToggleReceiptDeclaration());
    };
    HealthDeclarationCatBEPage.prototype.onSubmit = function () {
        var _this = this;
    ...
    HealthDeclarationCatBEPage.prototype.showConfirmHealthDeclarationModal = function () {
        var _this = this;
    ...
    HealthDeclarationCatBEPage.prototype.persistAndNavigate = function (resetLicenseProvided) {
        var _this = this;
        this.deviceAuthenticationProvider.triggerLockScreen()
            .then(function () {
    ...
    HealthDeclarationCatBEPage.prototype.ionViewDidLeave = function () {
    ...
    ], HealthDeclarationCatBEPage.prototype, "navBar", void 0);
    HealthDeclarationCatBEPage = __decorate([
        IonicPage(),
        Component({
    ...
    return HealthDeclarationCatBEPage;
}(BasePageComponent));
export { HealthDeclarationCatBEPage };
//# sourceMappingURL=health-declaration.cat-be.page.js.map