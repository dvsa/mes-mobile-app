...
describe('HealthDeclarationCatDPage', () => {
  let fixture: ComponentFixture<HealthDeclarationCatDPage>;
  let component: HealthDeclarationCatDPage;
  ...
  beforeEach(async(() => {
    fixture = TestBed.createComponent(HealthDeclarationCatDPage);
