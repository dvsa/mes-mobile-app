...
var HealthDeclarationCatDPage = /** @class */ (function (_super) {
    __extends(HealthDeclarationCatDPage, _super);
    function HealthDeclarationCatDPage(store$, navController, navParams, platform, authenticationProvider, deviceAuthenticationProvider, translate, alertController) {
    ...
    HealthDeclarationCatDPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    HealthDeclarationCatDPage.prototype.clickBack = function () {
        var _this = this;
    ...
    HealthDeclarationCatDPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    HealthDeclarationCatDPage.prototype.ionViewWillEnter = function () {
        if (this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    HealthDeclarationCatDPage.prototype.getSignatureDrawCompleteAction = function () {
        return postTestDeclarationsActions.SIGNATURE_DATA_CHANGED;
    };
    HealthDeclarationCatDPage.prototype.getSignatureClearAction = function () {
        return postTestDeclarationsActions.SIGNATURE_DATA_CLEARED;
    };
    HealthDeclarationCatDPage.prototype.healthDeclarationChanged = function () {
        this.store$.dispatch(new postTestDeclarationsActions.ToggleHealthDeclaration());
    };
    HealthDeclarationCatDPage.prototype.receiptDeclarationChanged = function () {
        this.store$.dispatch(new postTestDeclarationsActions.ToggleReceiptDeclaration());
    };
    HealthDeclarationCatDPage.prototype.onSubmit = function () {
        var _this = this;
    ...
    HealthDeclarationCatDPage.prototype.showConfirmHealthDeclarationModal = function () {
        var _this = this;
    ...
    HealthDeclarationCatDPage.prototype.persistAndNavigate = function (resetLicenseProvided) {
        var _this = this;
        this.deviceAuthenticationProvider.triggerLockScreen()
            .then(function () {
    ...
    HealthDeclarationCatDPage.prototype.ionViewDidLeave = function () {
    ...
    ], HealthDeclarationCatDPage.prototype, "navBar", void 0);
    HealthDeclarationCatDPage = __decorate([
        IonicPage(),
        Component({
            selector: '.health-declaration-cat-d-page',
            templateUrl: 'health-declaration.cat-d.page.html',
        }),
    ...
    return HealthDeclarationCatDPage;
}(BasePageComponent));
export { HealthDeclarationCatDPage };
//# sourceMappingURL=health-declaration.cat-d.page.js.map