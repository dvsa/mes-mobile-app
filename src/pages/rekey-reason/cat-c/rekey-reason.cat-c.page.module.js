...
var RekeyReasonCatCPageModule = /** @class */ (function () {
    function RekeyReasonCatCPageModule() {
    }
    RekeyReasonCatCPageModule = __decorate([
        NgModule({
            declarations: [
                RekeyReasonCatCPage,
            ],
    ...
    ], RekeyReasonCatCPageModule);
    return RekeyReasonCatCPageModule;
}());
export { RekeyReasonCatCPageModule };
//# sourceMappingURL=rekey-reason.cat-c.page.module.js.map