...
var RekeyReasonCatCPage = /** @class */ (function (_super) {
    __extends(RekeyReasonCatCPage, _super);
    function RekeyReasonCatCPage(navController, platform, authenticationProvider, store$, modalController, loadingController) {
        ...
        _this.handleUploadOutcome = function (uploadStatus) {
            ...
            if (uploadStatus.hasUploadSucceeded || uploadStatus.isDuplicate) {
                _this.navController.push(CAT_C.REKEY_UPLOAD_OUTCOME_PAGE);
                return;
            }
    ...
    RekeyReasonCatCPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    RekeyReasonCatCPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new RekeyReasonViewDidEnter());
    };
    RekeyReasonCatCPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    RekeyReasonCatCPage.prototype.isFormValid = function () {
        var _this = this;
    ...
    RekeyReasonCatCPage.prototype.ipadIssueSelected = function (checked) {
        this.store$.dispatch(new IpadIssueSelected(checked));
    };
    RekeyReasonCatCPage.prototype.ipadIssueTechnicalFaultChanged = function (selected) {
        this.store$.dispatch(new IpadIssueTechFaultSelected());
    };
    RekeyReasonCatCPage.prototype.ipadIssueLostChanged = function (selected) {
        this.store$.dispatch(new IpadIssueLostSelected());
    };
    RekeyReasonCatCPage.prototype.ipadIssueStolenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueStolenSelected());
    };
    RekeyReasonCatCPage.prototype.ipadIssueBrokenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueBrokenSelected());
    };
    RekeyReasonCatCPage.prototype.otherSelected = function (checked) {
        this.store$.dispatch(new OtherSelected(checked));
    };
    RekeyReasonCatCPage.prototype.otherReasonChanged = function (reason) {
        this.store$.dispatch(new OtherReasonUpdated(reason));
    };
    RekeyReasonCatCPage.prototype.transferSelected = function (isChecked) {
    ...
    return RekeyReasonCatCPage;
}(BasePageComponent));
export { RekeyReasonCatCPage };
//# sourceMappingURL=rekey-reason.cat-c.page.js.map