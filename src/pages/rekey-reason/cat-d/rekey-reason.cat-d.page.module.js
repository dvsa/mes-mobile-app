...
var RekeyReasonCatDPageModule = /** @class */ (function () {
    function RekeyReasonCatDPageModule() {
    }
    RekeyReasonCatDPageModule = __decorate([
        NgModule({
            declarations: [
                RekeyReasonCatDPage,
            ],
    ...
    ], RekeyReasonCatDPageModule);
    return RekeyReasonCatDPageModule;
}());
export { RekeyReasonCatDPageModule };
//# sourceMappingURL=rekey-reason.cat-d.page.module.js.map