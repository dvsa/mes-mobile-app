...
import { REKEY_SEARCH_PAGE, JOURNAL_PAGE, CAT_HOME_TEST } from '../../page-names.constants';
...
var RekeyReasonCatHomeTestPage = /** @class */ (function (_super) {
    __extends(RekeyReasonCatHomeTestPage, _super);
    function RekeyReasonCatHomeTestPage(navController, platform, authenticationProvider, store$, modalController, loadingController) {
        ...
        _this.handleUploadOutcome = function (uploadStatus) {
            ...
            if (uploadStatus.hasUploadSucceeded || uploadStatus.isDuplicate) {
                _this.navController.push(CAT_HOME_TEST.REKEY_UPLOAD_OUTCOME_PAGE);
                return;
            }
    ...
    RekeyReasonCatHomeTestPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    RekeyReasonCatHomeTestPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new RekeyReasonViewDidEnter());
    };
    RekeyReasonCatHomeTestPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    RekeyReasonCatHomeTestPage.prototype.isFormValid = function () {
        var _this = this;
    ...
    RekeyReasonCatHomeTestPage.prototype.ipadIssueSelected = function (checked) {
        this.store$.dispatch(new IpadIssueSelected(checked));
    };
    RekeyReasonCatHomeTestPage.prototype.ipadIssueTechnicalFaultChanged = function (selected) {
        this.store$.dispatch(new IpadIssueTechFaultSelected());
    };
    RekeyReasonCatHomeTestPage.prototype.ipadIssueLostChanged = function (selected) {
        this.store$.dispatch(new IpadIssueLostSelected());
    };
    RekeyReasonCatHomeTestPage.prototype.ipadIssueStolenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueStolenSelected());
    };
    RekeyReasonCatHomeTestPage.prototype.ipadIssueBrokenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueBrokenSelected());
    };
    RekeyReasonCatHomeTestPage.prototype.otherSelected = function (checked) {
        this.store$.dispatch(new OtherSelected(checked));
    };
    RekeyReasonCatHomeTestPage.prototype.otherReasonChanged = function (reason) {
        this.store$.dispatch(new OtherReasonUpdated(reason));
    };
    RekeyReasonCatHomeTestPage.prototype.transferSelected = function (isChecked) {
    ...
    RekeyReasonCatHomeTestPage.prototype.staffNumberChanged = function (staffNumber) {
        if (this.isStaffNumberInvalid) {
            this.store$.dispatch(new ResetStaffNumberValidationError());
        }
        this.store$.dispatch(new SetExaminerConducted(staffNumber));
    };
    RekeyReasonCatHomeTestPage.prototype.onExitRekeyPressed = function () {
        this.showExitRekeyModal();
    };
    RekeyReasonCatHomeTestPage.prototype.showExitRekeyModal = function () {
        var options = { cssClass: 'mes-modal-alert text-zoom-regular' };
        this.modal = this.modalController.create('ExitRekeyModal', {}, options);
        this.modal.onDidDismiss(this.onExitRekeyModalDismiss);
        this.modal.present();
    };
    RekeyReasonCatHomeTestPage = __decorate([
        IonicPage(),
        Component({
            selector: '.rekey-reason-cat-home-test-page',
    ...
    return RekeyReasonCatHomeTestPage;
}(BasePageComponent));
export { RekeyReasonCatHomeTestPage };
//# sourceMappingURL=rekey-reason.cat-home-test.page.js.map