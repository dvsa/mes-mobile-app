...
import { CAT_ADI_PART2, REKEY_SEARCH_PAGE, JOURNAL_PAGE } from '../../page-names.constants';
...
var RekeyReasonCatADIPart2Page = /** @class */ (function (_super) {
    __extends(RekeyReasonCatADIPart2Page, _super);
    function RekeyReasonCatADIPart2Page(navController, platform, authenticationProvider, store$, modalController, loadingController) {
        ...
        _this.handleUploadOutcome = function (uploadStatus) {
            ...
            if (uploadStatus.hasUploadSucceeded || uploadStatus.isDuplicate) {
                _this.navController.push(CAT_ADI_PART2.REKEY_UPLOAD_OUTCOME_PAGE);
                return;
            }
    ...
    RekeyReasonCatADIPart2Page.prototype.ngOnInit = function () {
        var _this = this;
    ...
    RekeyReasonCatADIPart2Page.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new RekeyReasonViewDidEnter());
    };
    RekeyReasonCatADIPart2Page.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    RekeyReasonCatADIPart2Page.prototype.isFormValid = function () {
        var _this = this;
    ...
    RekeyReasonCatADIPart2Page.prototype.ipadIssueSelected = function (checked) {
        this.store$.dispatch(new IpadIssueSelected(checked));
    };
    RekeyReasonCatADIPart2Page.prototype.ipadIssueTechnicalFaultChanged = function (selected) {
        this.store$.dispatch(new IpadIssueTechFaultSelected());
    };
    RekeyReasonCatADIPart2Page.prototype.ipadIssueLostChanged = function (selected) {
        this.store$.dispatch(new IpadIssueLostSelected());
    };
    RekeyReasonCatADIPart2Page.prototype.ipadIssueStolenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueStolenSelected());
    };
    RekeyReasonCatADIPart2Page.prototype.ipadIssueBrokenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueBrokenSelected());
    };
    RekeyReasonCatADIPart2Page.prototype.otherSelected = function (checked) {
        this.store$.dispatch(new OtherSelected(checked));
    };
    RekeyReasonCatADIPart2Page.prototype.otherReasonChanged = function (reason) {
        this.store$.dispatch(new OtherReasonUpdated(reason));
    };
    RekeyReasonCatADIPart2Page.prototype.transferSelected = function (isChecked) {
    ...
    RekeyReasonCatADIPart2Page.prototype.staffNumberChanged = function (staffNumber) {
        if (this.isStaffNumberInvalid) {
            this.store$.dispatch(new ResetStaffNumberValidationError());
        }
        this.store$.dispatch(new SetExaminerConducted(staffNumber));
    };
    RekeyReasonCatADIPart2Page.prototype.onExitRekeyPressed = function () {
        this.showExitRekeyModal();
    };
    RekeyReasonCatADIPart2Page.prototype.showExitRekeyModal = function () {
        var options = { cssClass: 'mes-modal-alert text-zoom-regular' };
        this.modal = this.modalController.create('ExitRekeyModal', {}, options);
        this.modal.onDidDismiss(this.onExitRekeyModalDismiss);
        this.modal.present();
    };
    RekeyReasonCatADIPart2Page = __decorate([
        IonicPage(),
        Component({
            selector: '.rekey-reason-cat-adi-part2-page',
    ...
    return RekeyReasonCatADIPart2Page;
}(BasePageComponent));
export { RekeyReasonCatADIPart2Page };
//# sourceMappingURL=rekey-reason.cat-adi-part2.page.js.map