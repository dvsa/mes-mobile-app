...
var RekeyReasonCatADIPart2PageModule = /** @class */ (function () {
    function RekeyReasonCatADIPart2PageModule() {
    }
    RekeyReasonCatADIPart2PageModule = __decorate([
        NgModule({
            declarations: [
    ...
    ], RekeyReasonCatADIPart2PageModule);
    return RekeyReasonCatADIPart2PageModule;
}());
export { RekeyReasonCatADIPart2PageModule };
//# sourceMappingURL=rekey-reason.cat-adi-part2.page.module.js.map