...
var RekeyReasonCatBEPage = /** @class */ (function (_super) {
    __extends(RekeyReasonCatBEPage, _super);
    function RekeyReasonCatBEPage(navController, platform, authenticationProvider, store$, modalController, loadingController) {
    ...
    RekeyReasonCatBEPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    RekeyReasonCatBEPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new RekeyReasonViewDidEnter());
    };
    RekeyReasonCatBEPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    RekeyReasonCatBEPage.prototype.isFormValid = function () {
        var _this = this;
    ...
    RekeyReasonCatBEPage.prototype.ipadIssueSelected = function (checked) {
        this.store$.dispatch(new IpadIssueSelected(checked));
    };
    RekeyReasonCatBEPage.prototype.ipadIssueTechnicalFaultChanged = function (selected) {
        this.store$.dispatch(new IpadIssueTechFaultSelected());
    };
    RekeyReasonCatBEPage.prototype.ipadIssueLostChanged = function (selected) {
        this.store$.dispatch(new IpadIssueLostSelected());
    };
    RekeyReasonCatBEPage.prototype.ipadIssueStolenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueStolenSelected());
    };
    RekeyReasonCatBEPage.prototype.ipadIssueBrokenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueBrokenSelected());
    };
    RekeyReasonCatBEPage.prototype.otherSelected = function (checked) {
        this.store$.dispatch(new OtherSelected(checked));
    };
    RekeyReasonCatBEPage.prototype.otherReasonChanged = function (reason) {
        this.store$.dispatch(new OtherReasonUpdated(reason));
    };
    RekeyReasonCatBEPage.prototype.transferSelected = function (isChecked) {
    ...
    return RekeyReasonCatBEPage;
}(BasePageComponent));
export { RekeyReasonCatBEPage };
//# sourceMappingURL=rekey-reason.cat-be.page.js.map