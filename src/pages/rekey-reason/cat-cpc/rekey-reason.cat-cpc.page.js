...
import { REKEY_SEARCH_PAGE, JOURNAL_PAGE, CAT_CPC } from '../../page-names.constants';
...
var RekeyReasonCatCPCPage = /** @class */ (function (_super) {
    __extends(RekeyReasonCatCPCPage, _super);
    function RekeyReasonCatCPCPage(navController, platform, authenticationProvider, store$, modalController, loadingController) {
        ...
        _this.handleUploadOutcome = function (uploadStatus) {
            ...
            if (uploadStatus.hasUploadSucceeded || uploadStatus.isDuplicate) {
                _this.navController.push(CAT_CPC.REKEY_UPLOAD_OUTCOME_PAGE);
                return;
            }
    ...
    RekeyReasonCatCPCPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    RekeyReasonCatCPCPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new RekeyReasonViewDidEnter());
    };
    RekeyReasonCatCPCPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    RekeyReasonCatCPCPage.prototype.isFormValid = function () {
        var _this = this;
    ...
    RekeyReasonCatCPCPage.prototype.ipadIssueSelected = function (checked) {
        this.store$.dispatch(new IpadIssueSelected(checked));
    };
    RekeyReasonCatCPCPage.prototype.ipadIssueTechnicalFaultChanged = function (selected) {
        this.store$.dispatch(new IpadIssueTechFaultSelected());
    };
    RekeyReasonCatCPCPage.prototype.ipadIssueLostChanged = function (selected) {
        this.store$.dispatch(new IpadIssueLostSelected());
    };
    RekeyReasonCatCPCPage.prototype.ipadIssueStolenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueStolenSelected());
    };
    RekeyReasonCatCPCPage.prototype.ipadIssueBrokenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueBrokenSelected());
    };
    RekeyReasonCatCPCPage.prototype.otherSelected = function (checked) {
        this.store$.dispatch(new OtherSelected(checked));
    };
    RekeyReasonCatCPCPage.prototype.otherReasonChanged = function (reason) {
        this.store$.dispatch(new OtherReasonUpdated(reason));
    };
    RekeyReasonCatCPCPage.prototype.transferSelected = function (isChecked) {
    ...
    RekeyReasonCatCPCPage.prototype.staffNumberChanged = function (staffNumber) {
        if (this.isStaffNumberInvalid) {
            this.store$.dispatch(new ResetStaffNumberValidationError());
        }
        this.store$.dispatch(new SetExaminerConducted(staffNumber));
    };
    RekeyReasonCatCPCPage.prototype.onExitRekeyPressed = function () {
        this.showExitRekeyModal();
    };
    RekeyReasonCatCPCPage.prototype.showExitRekeyModal = function () {
        var options = { cssClass: 'mes-modal-alert text-zoom-regular' };
        this.modal = this.modalController.create('ExitRekeyModal', {}, options);
        this.modal.onDidDismiss(this.onExitRekeyModalDismiss);
        this.modal.present();
    };
    RekeyReasonCatCPCPage = __decorate([
        IonicPage(),
        Component({
            selector: '.rekey-reason-cat-cpc-page',
    ...
    return RekeyReasonCatCPCPage;
}(BasePageComponent));
export { RekeyReasonCatCPCPage };
//# sourceMappingURL=rekey-reason.cat-cpc.page.js.map