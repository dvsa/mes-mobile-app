...
describe('RekeyReasonCatAMod2Page', function () {
    var fixture;
    var component;
        ...
        TestBed.configureTestingModule({
            ...
            imports: [
                ...
                StoreModule.forRoot({
                    ...
                    // TODO - PREP-AMOD2 update to use Cat A Mod 2 Schema
    ...
    describe('Class', function () {
        ...
        describe('handleUploadOutcome', function () {
            ...
            it('should navigate to the next page and not display the retry modal when an upload is a duplicate', function () {
                ...
                component.handleUploadOutcome(uploadStatus);
                expect(component.handleLoadingUI).toHaveBeenCalledWith(false);
                expect(navContoller.push).toHaveBeenCalledWith(CAT_A_MOD2.REKEY_UPLOAD_OUTCOME_PAGE);
...
//# sourceMappingURL=rekey-reason.cat-a-mod2.page.spec.js.map