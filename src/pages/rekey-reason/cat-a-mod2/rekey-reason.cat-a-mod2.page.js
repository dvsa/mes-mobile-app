...
import { REKEY_SEARCH_PAGE, JOURNAL_PAGE, CAT_A_MOD2 } from '../../page-names.constants';
...
var RekeyReasonCatAMod2Page = /** @class */ (function (_super) {
    __extends(RekeyReasonCatAMod2Page, _super);
    function RekeyReasonCatAMod2Page(navController, platform, authenticationProvider, store$, modalController, loadingController) {
        ...
        _this.handleUploadOutcome = function (uploadStatus) {
            ...
            if (uploadStatus.hasUploadSucceeded || uploadStatus.isDuplicate) {
                _this.navController.push(CAT_A_MOD2.REKEY_UPLOAD_OUTCOME_PAGE);
                return;
            }
    ...
    RekeyReasonCatAMod2Page.prototype.ngOnInit = function () {
        var _this = this;
    ...
    RekeyReasonCatAMod2Page.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new RekeyReasonViewDidEnter());
    };
    RekeyReasonCatAMod2Page.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    RekeyReasonCatAMod2Page.prototype.isFormValid = function () {
        var _this = this;
    ...
    RekeyReasonCatAMod2Page.prototype.ipadIssueSelected = function (checked) {
        this.store$.dispatch(new IpadIssueSelected(checked));
    };
    RekeyReasonCatAMod2Page.prototype.ipadIssueTechnicalFaultChanged = function (selected) {
        this.store$.dispatch(new IpadIssueTechFaultSelected());
    };
    RekeyReasonCatAMod2Page.prototype.ipadIssueLostChanged = function (selected) {
        this.store$.dispatch(new IpadIssueLostSelected());
    };
    RekeyReasonCatAMod2Page.prototype.ipadIssueStolenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueStolenSelected());
    };
    RekeyReasonCatAMod2Page.prototype.ipadIssueBrokenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueBrokenSelected());
    };
    RekeyReasonCatAMod2Page.prototype.otherSelected = function (checked) {
        this.store$.dispatch(new OtherSelected(checked));
    };
    RekeyReasonCatAMod2Page.prototype.otherReasonChanged = function (reason) {
        this.store$.dispatch(new OtherReasonUpdated(reason));
    };
    RekeyReasonCatAMod2Page.prototype.transferSelected = function (isChecked) {
    ...
    RekeyReasonCatAMod2Page.prototype.staffNumberChanged = function (staffNumber) {
        if (this.isStaffNumberInvalid) {
            this.store$.dispatch(new ResetStaffNumberValidationError());
        }
        this.store$.dispatch(new SetExaminerConducted(staffNumber));
    };
    RekeyReasonCatAMod2Page.prototype.onExitRekeyPressed = function () {
        this.showExitRekeyModal();
    };
    RekeyReasonCatAMod2Page.prototype.showExitRekeyModal = function () {
        var options = { cssClass: 'mes-modal-alert text-zoom-regular' };
        this.modal = this.modalController.create('ExitRekeyModal', {}, options);
        this.modal.onDidDismiss(this.onExitRekeyModalDismiss);
        this.modal.present();
    };
    RekeyReasonCatAMod2Page = __decorate([
        IonicPage(),
        Component({
            selector: '.rekey-reason-cat-a-mod2-page',
            templateUrl: 'rekey-reason.cat-a-mod2.page.html',
        }),
    ...
    return RekeyReasonCatAMod2Page;
}(BasePageComponent));
export { RekeyReasonCatAMod2Page };
//# sourceMappingURL=rekey-reason.cat-a-mod2.page.js.map