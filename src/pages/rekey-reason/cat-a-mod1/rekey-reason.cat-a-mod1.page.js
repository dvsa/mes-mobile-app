...
import { REKEY_SEARCH_PAGE, JOURNAL_PAGE, CAT_A_MOD1 } from '../../page-names.constants';
...
var RekeyReasonCatAMod1Page = /** @class */ (function (_super) {
    __extends(RekeyReasonCatAMod1Page, _super);
    function RekeyReasonCatAMod1Page(navController, platform, authenticationProvider, store$, modalController, loadingController) {
        ...
        _this.handleUploadOutcome = function (uploadStatus) {
            ...
            if (uploadStatus.hasUploadSucceeded || uploadStatus.isDuplicate) {
                _this.navController.push(CAT_A_MOD1.REKEY_UPLOAD_OUTCOME_PAGE);
                return;
            }
    ...
    RekeyReasonCatAMod1Page.prototype.ngOnInit = function () {
        var _this = this;
    ...
    RekeyReasonCatAMod1Page.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new RekeyReasonViewDidEnter());
    };
    RekeyReasonCatAMod1Page.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    RekeyReasonCatAMod1Page.prototype.isFormValid = function () {
        var _this = this;
    ...
    RekeyReasonCatAMod1Page.prototype.ipadIssueSelected = function (checked) {
        this.store$.dispatch(new IpadIssueSelected(checked));
    };
    RekeyReasonCatAMod1Page.prototype.ipadIssueTechnicalFaultChanged = function (selected) {
        this.store$.dispatch(new IpadIssueTechFaultSelected());
    };
    RekeyReasonCatAMod1Page.prototype.ipadIssueLostChanged = function (selected) {
        this.store$.dispatch(new IpadIssueLostSelected());
    };
    RekeyReasonCatAMod1Page.prototype.ipadIssueStolenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueStolenSelected());
    };
    RekeyReasonCatAMod1Page.prototype.ipadIssueBrokenChanged = function (selected) {
        this.store$.dispatch(new IpadIssueBrokenSelected());
    };
    RekeyReasonCatAMod1Page.prototype.otherSelected = function (checked) {
        this.store$.dispatch(new OtherSelected(checked));
    };
    RekeyReasonCatAMod1Page.prototype.otherReasonChanged = function (reason) {
        this.store$.dispatch(new OtherReasonUpdated(reason));
    };
    RekeyReasonCatAMod1Page.prototype.transferSelected = function (isChecked) {
    ...
    RekeyReasonCatAMod1Page.prototype.staffNumberChanged = function (staffNumber) {
        if (this.isStaffNumberInvalid) {
            this.store$.dispatch(new ResetStaffNumberValidationError());
        }
        this.store$.dispatch(new SetExaminerConducted(staffNumber));
    };
    RekeyReasonCatAMod1Page.prototype.onExitRekeyPressed = function () {
        this.showExitRekeyModal();
    };
    RekeyReasonCatAMod1Page.prototype.showExitRekeyModal = function () {
        var options = { cssClass: 'mes-modal-alert text-zoom-regular' };
        this.modal = this.modalController.create('ExitRekeyModal', {}, options);
        this.modal.onDidDismiss(this.onExitRekeyModalDismiss);
        this.modal.present();
    };
    RekeyReasonCatAMod1Page = __decorate([
        IonicPage(),
        Component({
            selector: '.rekey-reason-cat-a-mod1-page',
    ...
    return RekeyReasonCatAMod1Page;
}(BasePageComponent));
export { RekeyReasonCatAMod1Page };
//# sourceMappingURL=rekey-reason.cat-a-mod1.page.js.map