...
import { CAT_D, CONFIRM_TEST_DETAILS } from '../../page-names.constants';
...
var NonPassFinalisationCatDPage = /** @class */ (function (_super) {
    __extends(NonPassFinalisationCatDPage, _super);
    function NonPassFinalisationCatDPage(store$, navController, platform, authenticationProvider, outcomeBehaviourProvider, appConfig, modalController, activityCodeFinalisationProvider) {
        ...
        _this.onReturnToTestReport = function () {
            _this.invalidTestDataModal.dismiss();
            _this.navController.push(CAT_D.TEST_REPORT_PAGE, null, null, function (hasCompleted) { return hasCompleted && _this.removePostTestReportViews(); });
        };
    ...
    NonPassFinalisationCatDPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NonPassFinalisationCatDPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new NonPassFinalisationViewDidEnter());
    };
    NonPassFinalisationCatDPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    NonPassFinalisationCatDPage.prototype.openTestDataValidationModal = function () {
    ...
    NonPassFinalisationCatDPage.prototype.removePostTestReportViews = function () {
        var postDebriefPage = this.navController.getViews().find(function (view) { return view.id === CAT_D.POST_DEBRIEF_HOLDING_PAGE; });
        var nonPassFinalisationPage = this.navController
            .getViews().find(function (view) { return view.id === CAT_D.NON_PASS_FINALISATION_PAGE; });
        this.navController.removeView(postDebriefPage);
        this.navController.removeView(nonPassFinalisationPage);
    };
    NonPassFinalisationCatDPage.prototype.continue = function () {
    ...
    NonPassFinalisationCatDPage.prototype.activityCodeChanged = function (activityCodeModel) {
        this.activityCode = activityCodeModel;
        this.store$.dispatch(new SetActivityCode(activityCodeModel.activityCode));
    };
    NonPassFinalisationCatDPage.prototype.debriefWitnessedChanged = function (debriefWitnessed) {
        this.store$.dispatch(debriefWitnessed ? new DebriefWitnessed() : new DebriefUnwitnessed());
    };
    NonPassFinalisationCatDPage.prototype.d255Changed = function (d255) {
        this.store$.dispatch(d255 ? new D255Yes() : new D255No());
    };
    NonPassFinalisationCatDPage.prototype.transmissionChanged = function (transmission) {
        this.store$.dispatch(new GearboxCategoryChanged(transmission));
    };
    NonPassFinalisationCatDPage.prototype.isWelshChanged = function (isWelsh) {
    ...
    NonPassFinalisationCatDPage = __decorate([
        IonicPage(),
        Component({
    ...
    return NonPassFinalisationCatDPage;
}(BasePageComponent));
export { NonPassFinalisationCatDPage };
//# sourceMappingURL=non-pass-finalisation.cat-d.page.js.map