...
var NonPassFinalisationCatDPageModule = /** @class */ (function () {
    function NonPassFinalisationCatDPageModule() {
    }
    NonPassFinalisationCatDPageModule = __decorate([
        NgModule({
            declarations: [
    ...
    ], NonPassFinalisationCatDPageModule);
    return NonPassFinalisationCatDPageModule;
}());
export { NonPassFinalisationCatDPageModule };
//# sourceMappingURL=non-pass-finalisation.cat-d.page.module.js.map