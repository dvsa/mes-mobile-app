...
import { CAT_BE, CONFIRM_TEST_DETAILS } from '../../page-names.constants';
...
var NonPassFinalisationCatBEPage = /** @class */ (function (_super) {
    __extends(NonPassFinalisationCatBEPage, _super);
    function NonPassFinalisationCatBEPage(store$, navController, platform, authenticationProvider, outcomeBehaviourProvider, appConfig, modalController, activityCodeFinalisationProvider) {
        ...
        _this.onReturnToTestReport = function () {
            _this.invalidTestDataModal.dismiss();
            _this.navController.push(CAT_BE.TEST_REPORT_PAGE, null, null, function (hasCompleted) { return hasCompleted && _this.removePostTestReportViews(); });
        };
    ...
    NonPassFinalisationCatBEPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NonPassFinalisationCatBEPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new NonPassFinalisationViewDidEnter());
    };
    NonPassFinalisationCatBEPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    NonPassFinalisationCatBEPage.prototype.openTestDataValidationModal = function () {
    ...
    NonPassFinalisationCatBEPage.prototype.removePostTestReportViews = function () {
        var postDebriefPage = this.navController.getViews().find(function (view) { return view.id === CAT_BE.POST_DEBRIEF_HOLDING_PAGE; });
        var nonPassFinalisationPage = this.navController
            .getViews().find(function (view) { return view.id === CAT_BE.NON_PASS_FINALISATION_PAGE; });
        this.navController.removeView(postDebriefPage);
        this.navController.removeView(nonPassFinalisationPage);
    };
    NonPassFinalisationCatBEPage.prototype.continue = function () {
    ...
    NonPassFinalisationCatBEPage.prototype.activityCodeChanged = function (activityCodeModel) {
        this.activityCode = activityCodeModel;
        this.store$.dispatch(new SetActivityCode(activityCodeModel.activityCode));
    };
    NonPassFinalisationCatBEPage.prototype.debriefWitnessedChanged = function (debriefWitnessed) {
        this.store$.dispatch(debriefWitnessed ? new DebriefWitnessed() : new DebriefUnwitnessed());
    };
    NonPassFinalisationCatBEPage.prototype.d255Changed = function (d255) {
        this.store$.dispatch(d255 ? new D255Yes() : new D255No());
    };
    NonPassFinalisationCatBEPage.prototype.isWelshChanged = function (isWelsh) {
    ...
    NonPassFinalisationCatBEPage = __decorate([
        IonicPage(),
        Component({
    ...
    return NonPassFinalisationCatBEPage;
}(BasePageComponent));
export { NonPassFinalisationCatBEPage };
//# sourceMappingURL=non-pass-finalisation.cat-be.page.js.map