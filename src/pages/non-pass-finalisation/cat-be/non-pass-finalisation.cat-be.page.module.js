...
var NonPassFinalisationCatBEPageModule = /** @class */ (function () {
    function NonPassFinalisationCatBEPageModule() {
    }
    NonPassFinalisationCatBEPageModule = __decorate([
        NgModule({
            declarations: [
    ...
    return NonPassFinalisationCatBEPageModule;
}());
export { NonPassFinalisationCatBEPageModule };
//# sourceMappingURL=non-pass-finalisation.cat-be.page.module.js.map