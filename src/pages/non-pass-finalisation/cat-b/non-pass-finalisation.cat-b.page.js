...
var NonPassFinalisationCatBPage = /** @class */ (function (_super) {
    __extends(NonPassFinalisationCatBPage, _super);
    function NonPassFinalisationCatBPage(store$, navController, platform, authenticationProvider, outcomeBehaviourProvider, modalController, activityCodeFinalisationProvider) {
        ...
        _this.onReturnToTestReport = function () {
            _this.invalidTestDataModal.dismiss();
            _this.navController.push(CAT_B.TEST_REPORT_PAGE, null, null, function (hasCompleted) { return hasCompleted && _this.removePostTestReportViews(); });
        };
    ...
    NonPassFinalisationCatBPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NonPassFinalisationCatBPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new NonPassFinalisationViewDidEnter());
    };
    NonPassFinalisationCatBPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    NonPassFinalisationCatBPage.prototype.openTestDataValidationModal = function () {
    ...
    NonPassFinalisationCatBPage.prototype.removePostTestReportViews = function () {
        var postDebriefPage = this.navController.getViews().find(function (view) { return view.id === CAT_B.POST_DEBRIEF_HOLDING_PAGE; });
        var nonPassFinalisationPage = this.navController
            .getViews().find(function (view) { return view.id === CAT_B.NON_PASS_FINALISATION_PAGE; });
        this.navController.removeView(postDebriefPage);
        this.navController.removeView(nonPassFinalisationPage);
    };
    NonPassFinalisationCatBPage.prototype.continue = function () {
    ...
    NonPassFinalisationCatBPage.prototype.activityCodeChanged = function (activityCodeModel) {
        this.activityCode = activityCodeModel;
        this.store$.dispatch(new SetActivityCode(activityCodeModel.activityCode));
    };
    NonPassFinalisationCatBPage.prototype.debriefWitnessedChanged = function (debriefWitnessed) {
        this.store$.dispatch(debriefWitnessed ? new DebriefWitnessed() : new DebriefUnwitnessed());
    };
    NonPassFinalisationCatBPage.prototype.d255Changed = function (d255) {
        this.store$.dispatch(d255 ? new D255Yes() : new D255No());
    };
    NonPassFinalisationCatBPage.prototype.isWelshChanged = function (isWelsh) {
    ...
    NonPassFinalisationCatBPage = __decorate([
        IonicPage(),
        Component({
    ...
    return NonPassFinalisationCatBPage;
}(PracticeableBasePageComponent));
export { NonPassFinalisationCatBPage };
//# sourceMappingURL=non-pass-finalisation.cat-b.page.js.map