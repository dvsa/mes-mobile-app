...
import { DebriefWitnessed, D255Yes, D255No, DebriefUnwitnessed } from '../../../../modules/tests/test-summary/common/test-summary.actions';
...
describe('NonPassFinalisationCatBPage', function () {
    var fixture;
    var component;
    var store$;
            ...
            it('should create the TestFinalisationInvalidTestDataModal when activityCode is 5 and no S/D faults', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // Arrange
                            store$.dispatch(new testActions.StartTest(123, "B" /* B */));
...
//# sourceMappingURL=non-pass-finalisation.cat-b.page.spec.js.map