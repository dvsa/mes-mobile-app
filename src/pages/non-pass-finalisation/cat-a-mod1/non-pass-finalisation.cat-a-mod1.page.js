...
import { CAT_A_MOD1, CONFIRM_TEST_DETAILS } from '../../page-names.constants';
...
var NonPassFinalisationCatAMod1Page = /** @class */ (function (_super) {
    __extends(NonPassFinalisationCatAMod1Page, _super);
    function NonPassFinalisationCatAMod1Page(store$, navController, platform, authenticationProvider, outcomeBehaviourProvider, modalController, activityCodeFinalisationProvider) {
        ...
        _this.onReturnToTestReport = function () {
            _this.invalidTestDataModal.dismiss();
            _this.navController.push(CAT_A_MOD1.TEST_REPORT_PAGE, null, null, function (hasCompleted) { return hasCompleted && _this.removePostTestReportViews(); });
        };
    ...
    NonPassFinalisationCatAMod1Page.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NonPassFinalisationCatAMod1Page.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new NonPassFinalisationViewDidEnter());
    };
    NonPassFinalisationCatAMod1Page.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    NonPassFinalisationCatAMod1Page.prototype.openTestDataValidationModal = function () {
    ...
    NonPassFinalisationCatAMod1Page.prototype.removePostTestReportViews = function () {
        var postDebriefPage = this.navController
            .getViews().find(function (view) { return view.id === CAT_A_MOD1.POST_DEBRIEF_HOLDING_PAGE; });
        var nonPassFinalisationPage = this.navController
            .getViews().find(function (view) { return view.id === CAT_A_MOD1.NON_PASS_FINALISATION_PAGE; });
        this.navController.removeView(postDebriefPage);
        this.navController.removeView(nonPassFinalisationPage);
    };
    NonPassFinalisationCatAMod1Page.prototype.continue = function () {
    ...
    NonPassFinalisationCatAMod1Page.prototype.activityCodeChanged = function (activityCodeModel) {
        this.activityCode = activityCodeModel;
        this.store$.dispatch(new SetActivityCode(activityCodeModel.activityCode));
    };
    NonPassFinalisationCatAMod1Page.prototype.debriefWitnessedChanged = function (debriefWitnessed) {
        this.store$.dispatch(debriefWitnessed ? new DebriefWitnessed() : new DebriefUnwitnessed());
    };
    NonPassFinalisationCatAMod1Page.prototype.d255Changed = function (d255) {
        this.store$.dispatch(d255 ? new D255Yes() : new D255No());
    };
    NonPassFinalisationCatAMod1Page.prototype.isWelshChanged = function (isWelsh) {
    ...
    NonPassFinalisationCatAMod1Page = __decorate([
        IonicPage(),
        Component({
            selector: '.non-pass-finalisation-cat-a-mod1-page',
    ...
    return NonPassFinalisationCatAMod1Page;
}(BasePageComponent));
export { NonPassFinalisationCatAMod1Page };
//# sourceMappingURL=non-pass-finalisation.cat-a-mod1.page.js.map