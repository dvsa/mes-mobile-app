...
import { CAT_C, CONFIRM_TEST_DETAILS } from '../../page-names.constants';
...
var NonPassFinalisationCatCPage = /** @class */ (function (_super) {
    __extends(NonPassFinalisationCatCPage, _super);
    function NonPassFinalisationCatCPage(store$, navController, platform, authenticationProvider, outcomeBehaviourProvider, appConfig, modalController, activityCodeFinalisationProvider) {
        ...
        _this.onReturnToTestReport = function () {
            _this.invalidTestDataModal.dismiss();
            _this.navController.push(CAT_C.TEST_REPORT_PAGE, null, null, function (hasCompleted) { return hasCompleted && _this.removePostTestReportViews(); });
        };
    ...
    NonPassFinalisationCatCPage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        var _a = this.pageState, testData$ = _a.testData$, slotId$ = _a.slotId$, activityCode$ = _a.activityCode$, category$ = _a.category$;
    ...
    NonPassFinalisationCatCPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new NonPassFinalisationViewDidEnter());
    };
    NonPassFinalisationCatCPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    NonPassFinalisationCatCPage.prototype.openTestDataValidationModal = function () {
    ...
    NonPassFinalisationCatCPage.prototype.removePostTestReportViews = function () {
        var postDebriefPage = this.navController.getViews().find(function (view) { return view.id === CAT_C.POST_DEBRIEF_HOLDING_PAGE; });
        var nonPassFinalisationPage = this.navController
            .getViews().find(function (view) { return view.id === CAT_C.NON_PASS_FINALISATION_PAGE; });
        this.navController.removeView(postDebriefPage);
        this.navController.removeView(nonPassFinalisationPage);
    };
    NonPassFinalisationCatCPage.prototype.continue = function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.activityCodeFinalisationProvider
                                .catCTestDataIsInvalid(this.activityCode.activityCode, this.testData, this.category)];
                    case 1:
    ...
    NonPassFinalisationCatCPage.prototype.activityCodeChanged = function (activityCodeModel) {
        this.activityCode = activityCodeModel;
        this.store$.dispatch(new SetActivityCode(activityCodeModel.activityCode));
    };
    NonPassFinalisationCatCPage.prototype.debriefWitnessedChanged = function (debriefWitnessed) {
        this.store$.dispatch(debriefWitnessed ? new DebriefWitnessed() : new DebriefUnwitnessed());
    };
    NonPassFinalisationCatCPage.prototype.d255Changed = function (d255) {
        this.store$.dispatch(d255 ? new D255Yes() : new D255No());
    };
    NonPassFinalisationCatCPage.prototype.transmissionChanged = function (transmission) {
        this.store$.dispatch(new GearboxCategoryChanged(transmission));
    };
    NonPassFinalisationCatCPage.prototype.isWelshChanged = function (isWelsh) {
    ...
    NonPassFinalisationCatCPage = __decorate([
        IonicPage(),
        Component({
    ...
    return NonPassFinalisationCatCPage;
}(BasePageComponent));
export { NonPassFinalisationCatCPage };
//# sourceMappingURL=non-pass-finalisation.cat-c.page.js.map