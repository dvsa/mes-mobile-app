...
describe('NonPassFinalisationCatHomeTestPage', () => {
  let fixture: ComponentFixture<NonPassFinalisationCatHomeTestPage>;
  let component: NonPassFinalisationCatHomeTestPage;
