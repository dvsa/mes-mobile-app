...
var NonPassFinalisationCatAMod2Page = /** @class */ (function (_super) {
    __extends(NonPassFinalisationCatAMod2Page, _super);
    function NonPassFinalisationCatAMod2Page(store$, navController, platform, authenticationProvider, outcomeBehaviourProvider, modalController, activityCodeFinalisationProvider) {
        ...
        _this.onReturnToTestReport = function () {
            _this.invalidTestDataModal.dismiss();
            _this.navController.push(CAT_A_MOD2.TEST_REPORT_PAGE, null, null, function (hasCompleted) { return hasCompleted && _this.removePostTestReportViews(); });
        };
    ...
    NonPassFinalisationCatAMod2Page.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NonPassFinalisationCatAMod2Page.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new NonPassFinalisationViewDidEnter());
    };
    NonPassFinalisationCatAMod2Page.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    NonPassFinalisationCatAMod2Page.prototype.openTestDataValidationModal = function () {
    ...
    NonPassFinalisationCatAMod2Page.prototype.removePostTestReportViews = function () {
        var postDebriefPage = this.navController
            .getViews().find(function (view) { return view.id === CAT_A_MOD2.POST_DEBRIEF_HOLDING_PAGE; });
        var nonPassFinalisationPage = this.navController
            .getViews().find(function (view) { return view.id === CAT_A_MOD2.NON_PASS_FINALISATION_PAGE; });
        this.navController.removeView(postDebriefPage);
        this.navController.removeView(nonPassFinalisationPage);
    };
    NonPassFinalisationCatAMod2Page.prototype.continue = function () {
    ...
    NonPassFinalisationCatAMod2Page.prototype.activityCodeChanged = function (activityCodeModel) {
        this.activityCode = activityCodeModel;
        this.store$.dispatch(new SetActivityCode(activityCodeModel.activityCode));
    };
    NonPassFinalisationCatAMod2Page.prototype.debriefWitnessedChanged = function (debriefWitnessed) {
        this.store$.dispatch(debriefWitnessed ? new DebriefWitnessed() : new DebriefUnwitnessed());
    };
    NonPassFinalisationCatAMod2Page.prototype.d255Changed = function (d255) {
        this.store$.dispatch(d255 ? new D255Yes() : new D255No());
    };
    NonPassFinalisationCatAMod2Page.prototype.isWelshChanged = function (isWelsh) {
    ...
    NonPassFinalisationCatAMod2Page = __decorate([
        IonicPage(),
        Component({
            selector: '.non-pass-finalisation-cat-a-mod2-page',
    ...
    return NonPassFinalisationCatAMod2Page;
}(BasePageComponent));
export { NonPassFinalisationCatAMod2Page };
//# sourceMappingURL=non-pass-finalisation.cat-a-mod2.page.js.map