...
var NonPassFinalisationCatCPCPageModule = /** @class */ (function () {
    function NonPassFinalisationCatCPCPageModule() {
    }
    NonPassFinalisationCatCPCPageModule = __decorate([
        NgModule({
            declarations: [
    ...
    ], NonPassFinalisationCatCPCPageModule);
    return NonPassFinalisationCatCPCPageModule;
}());
export { NonPassFinalisationCatCPCPageModule };
//# sourceMappingURL=non-pass-finalisation.cat-cpc.page.module.js.map