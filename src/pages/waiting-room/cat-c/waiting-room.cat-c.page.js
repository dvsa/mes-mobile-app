...
var WaitingRoomCatCPage = /** @class */ (function (_super) {
    __extends(WaitingRoomCatCPage, _super);
    function WaitingRoomCatCPage(store$, navController, navParams, platform, authenticationProvider, deviceAuthenticationProvider, deviceProvider, screenOrientation, insomnia, translate, modalController, app) {
    ...
    WaitingRoomCatCPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    WaitingRoomCatCPage.prototype.clickBack = function () {
        var _this = this;
    ...
    WaitingRoomCatCPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    WaitingRoomCatCPage.prototype.ionViewWillEnter = function () {
        if (this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    WaitingRoomCatCPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    WaitingRoomCatCPage.prototype.getSignatureDrawCompleteAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CHANGED;
    };
    WaitingRoomCatCPage.prototype.getSignatureClearAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CLEARED;
    };
    WaitingRoomCatCPage.prototype.insuranceDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleInsuranceDeclaration());
    };
    WaitingRoomCatCPage.prototype.residencyDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleResidencyDeclaration());
    };
    WaitingRoomCatCPage.prototype.dispatchCandidateChoseToProceedInWelsh = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInWelsh(Language.CYMRAEG));
    };
    WaitingRoomCatCPage.prototype.dispatchCandidateChoseToProceedInEnglish = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInEnglish(Language.ENGLISH));
    };
    WaitingRoomCatCPage.prototype.onSubmit = function () {
        var _this = this;
    ...
    WaitingRoomCatCPage.prototype.showCandidateDataMissingError = function () {
        var _this = this;
    ...
    ], WaitingRoomCatCPage.prototype, "navBar", void 0);
    WaitingRoomCatCPage = __decorate([
        IonicPage(),
        Component({
    ...
    return WaitingRoomCatCPage;
}(BasePageComponent));
export { WaitingRoomCatCPage };
//# sourceMappingURL=waiting-room.cat-c.page.js.map