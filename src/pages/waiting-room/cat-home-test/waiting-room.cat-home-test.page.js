...
import { CAT_HOME_TEST, ERROR_PAGE, LOGIN_PAGE } from '../../page-names.constants';
...
var WaitingRoomCatHomeTestPage = /** @class */ (function (_super) {
    __extends(WaitingRoomCatHomeTestPage, _super);
    function WaitingRoomCatHomeTestPage(store$, navController, navParams, platform, authenticationProvider, deviceAuthenticationProvider, deviceProvider, screenOrientation, insomnia, translate, modalController, app) {
    ...
    WaitingRoomCatHomeTestPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    WaitingRoomCatHomeTestPage.prototype.clickBack = function () {
        var _this = this;
    ...
    WaitingRoomCatHomeTestPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    WaitingRoomCatHomeTestPage.prototype.ionViewWillEnter = function () {
        if (this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    WaitingRoomCatHomeTestPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    WaitingRoomCatHomeTestPage.prototype.getSignatureDrawCompleteAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CHANGED;
    };
    WaitingRoomCatHomeTestPage.prototype.getSignatureClearAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CLEARED;
    };
    WaitingRoomCatHomeTestPage.prototype.insuranceDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleInsuranceDeclaration());
    };
    WaitingRoomCatHomeTestPage.prototype.residencyDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleResidencyDeclaration());
    };
    WaitingRoomCatHomeTestPage.prototype.dispatchCandidateChoseToProceedInWelsh = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInWelsh(Language.CYMRAEG));
    };
    WaitingRoomCatHomeTestPage.prototype.dispatchCandidateChoseToProceedInEnglish = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInEnglish(Language.ENGLISH));
    };
    WaitingRoomCatHomeTestPage.prototype.onSubmit = function () {
        var _this = this;
        ...
        if (this.formGroup.valid) {
            this.navController.push(CAT_HOME_TEST.COMMUNICATION_PAGE);
        }
        else {
    ...
    WaitingRoomCatHomeTestPage.prototype.showCandidateDataMissingError = function () {
        var _this = this;
    ...
    ], WaitingRoomCatHomeTestPage.prototype, "navBar", void 0);
    WaitingRoomCatHomeTestPage = __decorate([
        IonicPage(),
        Component({
            selector: '.waiting-room-cat-home-test-page',
        ...
        __metadata("design:paramtypes", [Store,
            ...
            ModalController,
            App])
    ], WaitingRoomCatHomeTestPage);
    return WaitingRoomCatHomeTestPage;
}(BasePageComponent));
export { WaitingRoomCatHomeTestPage };
//# sourceMappingURL=waiting-room.cat-home-test.page.js.map