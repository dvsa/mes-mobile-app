...
// TODO - HOME TEST - Fix Candidate Reducer
...
export class WaitingRoomCatHomeTestPage extends BasePageComponent implements OnInit {
  ...
  merged$: Observable<boolean | string | CatFUniqueTypes.JournalData>;
  ...
  ngOnInit(): void {
    ...
    this.merged$ = merge(
      currentTest$.pipe(
        select(getJournalData),
        tap((journalData: CatFUniqueTypes.JournalData) => {
  ...
  isJournalDataInvalid = (journalData: CatFUniqueTypes.JournalData): boolean => {
