...
import { getPreTestDeclarationsCatAMod2, } from '../../../modules/tests/pre-test-declarations/cat-a-mod2/pre-test-declarations.cat-a-mod2.reducer';
...
import { getCBTNumberStatus } from '../../../modules/tests/pre-test-declarations/cat-a-mod2/pre-test-declarations.cat-a-mod2.selector';
...
var WaitingRoomCatAMod2Page = /** @class */ (function (_super) {
    __extends(WaitingRoomCatAMod2Page, _super);
    function WaitingRoomCatAMod2Page(store$, navController, navParams, platform, authenticationProvider, deviceAuthenticationProvider, deviceProvider, screenOrientation, insomnia, translate, modalController, app) {
    ...
    WaitingRoomCatAMod2Page.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    WaitingRoomCatAMod2Page.prototype.clickBack = function () {
        var _this = this;
    ...
    WaitingRoomCatAMod2Page.prototype.ngOnInit = function () {
        var _this = this;
        var currentTest$ = this.store$.pipe(select(getTests), select(getCurrentTest));
        this.pageState = {
            insuranceDeclarationAccepted$: currentTest$.pipe(select(getPreTestDeclarationsCatAMod2), select(getInsuranceDeclarationStatus)),
            residencyDeclarationAccepted$: currentTest$.pipe(select(getPreTestDeclarationsCatAMod2), select(getResidencyDeclarationStatus)),
            signature$: currentTest$.pipe(select(getPreTestDeclarationsCatAMod2), select(getSignatureStatus)),
            ...
            cbtNumber$: currentTest$.pipe(select(getPreTestDeclarationsCatAMod2), select(getCBTNumberStatus)),
        };
    ...
    WaitingRoomCatAMod2Page.prototype.ionViewWillEnter = function () {
        if (this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    WaitingRoomCatAMod2Page.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    WaitingRoomCatAMod2Page.prototype.getSignatureDrawCompleteAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CHANGED;
    };
    WaitingRoomCatAMod2Page.prototype.getSignatureClearAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CLEARED;
    };
    WaitingRoomCatAMod2Page.prototype.insuranceDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleInsuranceDeclaration());
    };
    WaitingRoomCatAMod2Page.prototype.residencyDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleResidencyDeclaration());
    };
    WaitingRoomCatAMod2Page.prototype.dispatchCandidateChoseToProceedInWelsh = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInWelsh(Language.CYMRAEG));
    };
    WaitingRoomCatAMod2Page.prototype.dispatchCandidateChoseToProceedInEnglish = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInEnglish(Language.ENGLISH));
    };
    WaitingRoomCatAMod2Page.prototype.cbtNumberChanged = function (cbtNumber) {
        this.store$.dispatch(new preTestDeclarationsActionsCatA.CbtNumberChanged(cbtNumber));
    };
    WaitingRoomCatAMod2Page.prototype.onSubmit = function () {
        var _this = this;
    ...
    WaitingRoomCatAMod2Page.prototype.showCandidateDataMissingError = function () {
        var _this = this;
    ...
    ], WaitingRoomCatAMod2Page.prototype, "navBar", void 0);
    WaitingRoomCatAMod2Page = __decorate([
        IonicPage(),
        Component({
    ...
    return WaitingRoomCatAMod2Page;
}(BasePageComponent));
export { WaitingRoomCatAMod2Page };
//# sourceMappingURL=waiting-room.cat-a-mod2.page.js.map