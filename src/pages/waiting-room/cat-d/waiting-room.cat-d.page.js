...
var WaitingRoomCatDPage = /** @class */ (function (_super) {
    __extends(WaitingRoomCatDPage, _super);
    function WaitingRoomCatDPage(store$, navController, navParams, platform, authenticationProvider, deviceAuthenticationProvider, deviceProvider, screenOrientation, insomnia, translate, modalController, app) {
    ...
    WaitingRoomCatDPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    WaitingRoomCatDPage.prototype.clickBack = function () {
        var _this = this;
    ...
    WaitingRoomCatDPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    WaitingRoomCatDPage.prototype.ionViewWillEnter = function () {
        if (this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    WaitingRoomCatDPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    WaitingRoomCatDPage.prototype.getSignatureDrawCompleteAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CHANGED;
    };
    WaitingRoomCatDPage.prototype.getSignatureClearAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CLEARED;
    };
    WaitingRoomCatDPage.prototype.insuranceDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleInsuranceDeclaration());
    };
    WaitingRoomCatDPage.prototype.residencyDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleResidencyDeclaration());
    };
    WaitingRoomCatDPage.prototype.dispatchCandidateChoseToProceedInWelsh = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInWelsh(Language.CYMRAEG));
    };
    WaitingRoomCatDPage.prototype.dispatchCandidateChoseToProceedInEnglish = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInEnglish(Language.ENGLISH));
    };
    WaitingRoomCatDPage.prototype.onSubmit = function () {
        var _this = this;
    ...
    WaitingRoomCatDPage.prototype.showCandidateDataMissingError = function () {
        var _this = this;
    ...
    ], WaitingRoomCatDPage.prototype, "navBar", void 0);
    WaitingRoomCatDPage = __decorate([
        IonicPage(),
        Component({
    ...
    return WaitingRoomCatDPage;
}(BasePageComponent));
export { WaitingRoomCatDPage };
//# sourceMappingURL=waiting-room.cat-d.page.js.map