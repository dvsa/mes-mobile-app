...
import { getPreTestDeclarationsCatAMod1 } from '../../../modules/tests/pre-test-declarations/cat-a-mod1/pre-test-declarations.cat-a-mod1.reducer';
import * as preTestDeclarationsActionsCatA from '../../../modules/tests/pre-test-declarations/cat-a/pre-test-declarations.cat-a.actions';
...
import { getCBTNumberStatus } from '../../../modules/tests/pre-test-declarations/cat-a-mod1/pre-test-declarations.cat-a-mod1.selector';
...
import { ERROR_PAGE, LOGIN_PAGE, CAT_A_MOD1 } from '../../page-names.constants';
...
var WaitingRoomCatAMod1Page = /** @class */ (function (_super) {
    __extends(WaitingRoomCatAMod1Page, _super);
    function WaitingRoomCatAMod1Page(store$, navController, navParams, platform, authenticationProvider, deviceAuthenticationProvider, deviceProvider, screenOrientation, insomnia, translate, modalController, app) {
    ...
    WaitingRoomCatAMod1Page.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    WaitingRoomCatAMod1Page.prototype.clickBack = function () {
        var _this = this;
    ...
    WaitingRoomCatAMod1Page.prototype.ngOnInit = function () {
        var _this = this;
        var currentTest$ = this.store$.pipe(select(getTests), select(getCurrentTest));
        this.pageState = {
            insuranceDeclarationAccepted$: currentTest$.pipe(select(getPreTestDeclarationsCatAMod1), select(getInsuranceDeclarationStatus)),
            residencyDeclarationAccepted$: currentTest$.pipe(select(getPreTestDeclarationsCatAMod1), select(getResidencyDeclarationStatus)),
            signature$: currentTest$.pipe(select(getPreTestDeclarationsCatAMod1), select(getSignatureStatus)),
    ...
    WaitingRoomCatAMod1Page.prototype.ionViewWillEnter = function () {
        if (this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    WaitingRoomCatAMod1Page.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    WaitingRoomCatAMod1Page.prototype.getSignatureDrawCompleteAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CHANGED;
    };
    WaitingRoomCatAMod1Page.prototype.getSignatureClearAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CLEARED;
    };
    WaitingRoomCatAMod1Page.prototype.insuranceDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleInsuranceDeclaration());
    };
    WaitingRoomCatAMod1Page.prototype.residencyDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleResidencyDeclaration());
    };
    WaitingRoomCatAMod1Page.prototype.dispatchCandidateChoseToProceedInWelsh = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInWelsh(Language.CYMRAEG));
    };
    WaitingRoomCatAMod1Page.prototype.dispatchCandidateChoseToProceedInEnglish = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInEnglish(Language.ENGLISH));
    };
    WaitingRoomCatAMod1Page.prototype.cbtNumberChanged = function (cbtNumber) {
        this.store$.dispatch(new preTestDeclarationsActionsCatA.CbtNumberChanged(cbtNumber));
    };
    WaitingRoomCatAMod1Page.prototype.onSubmit = function () {
        var _this = this;
        ...
        if (this.formGroup.valid) {
            this.navController.push(CAT_A_MOD1.COMMUNICATION_PAGE);
        }
        else {
            Object.keys(this.formGroup.controls).forEach(function (controlName) {
                if (_this.formGroup.controls[controlName].invalid) {
                    if (controlName === CBT_NUMBER_CTRL) {
                        _this.store$.dispatch(new waitingRoomActions.WaitingRoomValidationError(controlName + " is invalid"));
                    }
                    else {
    ...
    WaitingRoomCatAMod1Page.prototype.showCandidateDataMissingError = function () {
        var _this = this;
    ...
    ], WaitingRoomCatAMod1Page.prototype, "navBar", void 0);
    WaitingRoomCatAMod1Page = __decorate([
        IonicPage(),
        Component({
    ...
    return WaitingRoomCatAMod1Page;
}(BasePageComponent));
export { WaitingRoomCatAMod1Page };
//# sourceMappingURL=waiting-room.cat-a-mod1.page.js.map