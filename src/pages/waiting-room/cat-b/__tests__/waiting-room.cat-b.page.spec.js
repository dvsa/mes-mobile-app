...
describe('WaitingRoomCatBPage', function () {
    var fixture;
    var component;
    var store$;
    var deviceProvider;
    ...
    describe('Class', function () {
        ...
        describe('ionViewDidEnter', function () {
            it('should enable single app mode if on ios and not in practice mode', function () {
                component.isPracticeMode = false;
                component.ionViewDidEnter();
                expect(deviceProvider.enableSingleAppMode).toHaveBeenCalled();
            });
            it('should note enable single app mode if on ios and in practice mode', function () {
...
//# sourceMappingURL=waiting-room.cat-b.page.spec.js.map