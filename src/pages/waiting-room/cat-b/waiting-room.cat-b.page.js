...
var WaitingRoomCatBPage = /** @class */ (function (_super) {
    __extends(WaitingRoomCatBPage, _super);
    function WaitingRoomCatBPage(store$, navController, navParams, platform, authenticationProvider, deviceAuthenticationProvider, deviceProvider, screenOrientation, insomnia, translate, modalController, app) {
    ...
    WaitingRoomCatBPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    WaitingRoomCatBPage.prototype.clickBack = function () {
        var _this = this;
    ...
    WaitingRoomCatBPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    WaitingRoomCatBPage.prototype.ionViewWillEnter = function () {
        if (this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    WaitingRoomCatBPage.prototype.ionViewDidLeave = function () {
        _super.prototype.ionViewDidLeave.call(this);
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    WaitingRoomCatBPage.prototype.getSignatureDrawCompleteAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CHANGED;
    };
    WaitingRoomCatBPage.prototype.getSignatureClearAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CLEARED;
    };
    WaitingRoomCatBPage.prototype.insuranceDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleInsuranceDeclaration());
    };
    WaitingRoomCatBPage.prototype.residencyDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleResidencyDeclaration());
    };
    WaitingRoomCatBPage.prototype.dispatchCandidateChoseToProceedInWelsh = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInWelsh(Language.CYMRAEG));
    };
    WaitingRoomCatBPage.prototype.dispatchCandidateChoseToProceedInEnglish = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInEnglish(Language.ENGLISH));
    };
    WaitingRoomCatBPage.prototype.onSubmit = function () {
        var _this = this;
    ...
    WaitingRoomCatBPage.prototype.showCandidateDataMissingError = function () {
        var _this = this;
    ...
    ], WaitingRoomCatBPage.prototype, "navBar", void 0);
    WaitingRoomCatBPage = __decorate([
        IonicPage(),
        Component({
    ...
    return WaitingRoomCatBPage;
}(PracticeableBasePageComponent));
export { WaitingRoomCatBPage };
//# sourceMappingURL=waiting-room.cat-b.page.js.map