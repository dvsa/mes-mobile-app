...
describe('Waiting Room Analytics Effects', function () {
    var effects;
    var analyticsProviderMock;
    var actions$;
    var store$;
    var screenName = AnalyticsScreenNames.WAITING_ROOM;
    var screenNamePracticeMode = AnalyticsEventCategories.PRACTICE_MODE + " - " + AnalyticsScreenNames.WAITING_ROOM;
    var mockApplication = {
    ...
    describe('waitingRoomViewDidEnter', function () {
        it('should call setCurrentPage and addCustomDimension', function (done) {
            ...
            // ASSERT
            effects.waitingRoomViewDidEnter$.subscribe(function (result) {
    ...
    describe('waitingRoomValidationError', function () {
        it('should call logError', function (done) {
            ...
            // ASSERT
            effects.waitingRoomValidationError$.subscribe(function (result) {
                expect(result instanceof AnalyticRecorded).toBe(true);
                expect(analyticsProviderMock.addCustomDimension)
                    .toHaveBeenCalledWith(AnalyticsDimensionIndices.TEST_CATEGORY, 'B');
...
//# sourceMappingURL=waiting-room.analytics.effects.spec.js.map