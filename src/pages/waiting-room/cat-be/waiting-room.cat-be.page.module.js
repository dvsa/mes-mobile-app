...
var WaitingRoomCatBEPageModule = /** @class */ (function () {
    function WaitingRoomCatBEPageModule() {
    }
    WaitingRoomCatBEPageModule = __decorate([
        NgModule({
            declarations: [
    ...
    return WaitingRoomCatBEPageModule;
}());
export { WaitingRoomCatBEPageModule };
//# sourceMappingURL=waiting-room.cat-be.page.module.js.map