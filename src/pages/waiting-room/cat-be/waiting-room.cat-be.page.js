...
var WaitingRoomCatBEPage = /** @class */ (function (_super) {
    __extends(WaitingRoomCatBEPage, _super);
    function WaitingRoomCatBEPage(store$, navController, navParams, platform, authenticationProvider, deviceAuthenticationProvider, deviceProvider, screenOrientation, insomnia, translate, modalController, app) {
    ...
    WaitingRoomCatBEPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    WaitingRoomCatBEPage.prototype.clickBack = function () {
        var _this = this;
    ...
    WaitingRoomCatBEPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    WaitingRoomCatBEPage.prototype.ionViewWillEnter = function () {
        if (this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
        return true;
    };
    WaitingRoomCatBEPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    WaitingRoomCatBEPage.prototype.getSignatureDrawCompleteAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CHANGED;
    };
    WaitingRoomCatBEPage.prototype.getSignatureClearAction = function () {
        return preTestDeclarationsActions.SIGNATURE_DATA_CLEARED;
    };
    WaitingRoomCatBEPage.prototype.insuranceDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleInsuranceDeclaration());
    };
    WaitingRoomCatBEPage.prototype.residencyDeclarationChanged = function () {
        this.store$.dispatch(new preTestDeclarationsActions.ToggleResidencyDeclaration());
    };
    WaitingRoomCatBEPage.prototype.dispatchCandidateChoseToProceedInWelsh = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInWelsh(Language.CYMRAEG));
    };
    WaitingRoomCatBEPage.prototype.dispatchCandidateChoseToProceedInEnglish = function () {
        this.store$.dispatch(new CandidateChoseToProceedWithTestInEnglish(Language.ENGLISH));
    };
    WaitingRoomCatBEPage.prototype.onSubmit = function () {
        var _this = this;
    ...
    WaitingRoomCatBEPage.prototype.showCandidateDataMissingError = function () {
        var _this = this;
    ...
    ], WaitingRoomCatBEPage.prototype, "navBar", void 0);
    WaitingRoomCatBEPage = __decorate([
        IonicPage(),
        Component({
    ...
    return WaitingRoomCatBEPage;
}(BasePageComponent));
export { WaitingRoomCatBEPage };
//# sourceMappingURL=waiting-room.cat-be.page.js.map