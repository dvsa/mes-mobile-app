...
var ViewTestResultCatHomeTestPage = /** @class */ (function (_super) {
    __extends(ViewTestResultCatHomeTestPage, _super);
    function ViewTestResultCatHomeTestPage(navController, platform, navParams, loadingController, authenticationProvider, searchProvider, compressionProvider, store$, logHelper, questionProvider) {
    ...
    ViewTestResultCatHomeTestPage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.subscription = this.searchProvider
            ...
            _this.testCategory = _this.testResult.category;
        });
    };
    ViewTestResultCatHomeTestPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    ViewTestResultCatHomeTestPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new ViewTestResultViewDidEnter(this.applicationReference));
    };
    ViewTestResultCatHomeTestPage.prototype.getTestDetails = function () {
        if (!this.testResult) {
            return null;
        }
    ...
    ViewTestResultCatHomeTestPage.prototype.getExaminerDetails = function () {
        if (!this.testResult) {
            return null;
        }
        return {
    ...
    ViewTestResultCatHomeTestPage.prototype.getHeaderDetails = function () {
        if (!this.testResult) {
            return null;
        }
        return {
    ...
    ViewTestResultCatHomeTestPage = __decorate([
        IonicPage(),
        Component({
    ...
    return ViewTestResultCatHomeTestPage;
}(BasePageComponent));
export { ViewTestResultCatHomeTestPage };
//# sourceMappingURL=view-test-result.cat-home-test.page.js.map