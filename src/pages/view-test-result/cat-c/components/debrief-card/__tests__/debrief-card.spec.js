...
describe('DebriefCardComponent', function () {
    ...
    describe('Class', function () {
        describe('getTestRequirements', function () {
            it('should return the correct values for all test requirements for Cat C', function () {
                var data = {
                    testRequirements: {
            ...
            it('should return the correct values for all test requirements for Cat CE', function () {
                var data = {
                    testRequirements: {
                        angledStartControlledStop: true,
                        downhillStart: false,
            ...
            it('should return the correct values for all test requirements for Cat C1', function () {
                var data = {
                    testRequirements: {
                        angledStartControlledStop: true,
                        downhillStart: false,
            ...
            it('should return the correct values for all test requirements for Cat C1E', function () {
                var data = {
                    testRequirements: {
                        angledStartControlledStop: true,
                        downhillStart: false,
