...
var ViewTestResultCatCPage = /** @class */ (function (_super) {
    __extends(ViewTestResultCatCPage, _super);
    function ViewTestResultCatCPage(navController, platform, navParams, loadingController, authenticationProvider, searchProvider, compressionProvider, store$, logHelper, questionProvider) {
    ...
    ViewTestResultCatCPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ViewTestResultCatCPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    ViewTestResultCatCPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new ViewTestResultViewDidEnter(this.applicationReference));
    };
    ViewTestResultCatCPage.prototype.getTestDetails = function () {
        if (!this.testResult) {
            return null;
        }
    ...
    ViewTestResultCatCPage.prototype.getExaminerDetails = function () {
        if (!this.testResult) {
            return null;
        }
        return {
    ...
    ViewTestResultCatCPage.prototype.getHeaderDetails = function () {
        if (!this.testResult) {
            return null;
        }
        return {
    ...
    ViewTestResultCatCPage = __decorate([
        IonicPage(),
        Component({
    ...
    return ViewTestResultCatCPage;
}(BasePageComponent));
export { ViewTestResultCatCPage };
//# sourceMappingURL=view-test-result.cat-c.page.js.map