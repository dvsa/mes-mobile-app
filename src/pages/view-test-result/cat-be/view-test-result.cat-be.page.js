...
var ViewTestResultCatBEPage = /** @class */ (function (_super) {
    __extends(ViewTestResultCatBEPage, _super);
    function ViewTestResultCatBEPage(navController, platform, navParams, loadingController, authenticationProvider, searchProvider, compressionProvider, store$, logHelper, questionProvider) {
    ...
    ViewTestResultCatBEPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ViewTestResultCatBEPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    ViewTestResultCatBEPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new ViewTestResultViewDidEnter(this.applicationReference));
    };
    ViewTestResultCatBEPage.prototype.getTestDetails = function () {
        if (!this.testResult) {
            return null;
        }
    ...
    ViewTestResultCatBEPage.prototype.getExaminerDetails = function () {
        if (!this.testResult) {
            return null;
        }
        return {
    ...
    ViewTestResultCatBEPage.prototype.getHeaderDetails = function () {
        if (!this.testResult) {
            return null;
        }
        return {
    ...
    ViewTestResultCatBEPage = __decorate([
        IonicPage(),
        Component({
    ...
    return ViewTestResultCatBEPage;
}(BasePageComponent));
export { ViewTestResultCatBEPage };
//# sourceMappingURL=view-test-result.cat-be.page.js.map