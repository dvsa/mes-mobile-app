...
var ViewTestResultCatAMod1Page = /** @class */ (function (_super) {
    __extends(ViewTestResultCatAMod1Page, _super);
    function ViewTestResultCatAMod1Page(navController, platform, navParams, loadingController, authenticationProvider, searchProvider, compressionProvider, store$, logHelper, questionProvider) {
    ...
    ViewTestResultCatAMod1Page.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ViewTestResultCatAMod1Page.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    ViewTestResultCatAMod1Page.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new ViewTestResultViewDidEnter(this.applicationReference));
    };
    ViewTestResultCatAMod1Page.prototype.getTestDetails = function () {
        if (!this.testResult) {
            return null;
        }
    ...
    ViewTestResultCatAMod1Page.prototype.getExaminerDetails = function () {
        if (!this.testResult) {
            return null;
        }
        return {
    ...
    ViewTestResultCatAMod1Page.prototype.getHeaderDetails = function () {
        if (!this.testResult) {
            return null;
        }
        return {
    ...
    ViewTestResultCatAMod1Page = __decorate([
        IonicPage(),
        Component({
    ...
    return ViewTestResultCatAMod1Page;
}(BasePageComponent));
export { ViewTestResultCatAMod1Page };
//# sourceMappingURL=view-test-result.cat-a-mod1.page.js.map