...
var ViewTestResultCatAMod2Page = /** @class */ (function (_super) {
    __extends(ViewTestResultCatAMod2Page, _super);
    function ViewTestResultCatAMod2Page(navController, platform, navParams, loadingController, authenticationProvider, searchProvider, compressionProvider, store$, logHelper, questionProvider) {
    ...
    ViewTestResultCatAMod2Page.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.subscription = this.searchProvider
            ...
            _this.testResult = categoryAM2TestResultMock;
    ...
    ViewTestResultCatAMod2Page.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    ViewTestResultCatAMod2Page.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new ViewTestResultViewDidEnter(this.applicationReference));
    };
    ViewTestResultCatAMod2Page.prototype.getTestDetails = function () {
        if (!this.testResult) {
            return null;
        }
    ...
    ViewTestResultCatAMod2Page.prototype.getExaminerDetails = function () {
        if (!this.testResult) {
            return null;
        }
        return {
    ...
    ViewTestResultCatAMod2Page.prototype.getHeaderDetails = function () {
        if (!this.testResult) {
            return null;
        }
        return {
    ...
    ViewTestResultCatAMod2Page = __decorate([
        IonicPage(),
        Component({
    ...
    return ViewTestResultCatAMod2Page;
}(BasePageComponent));
export { ViewTestResultCatAMod2Page };
//# sourceMappingURL=view-test-result.cat-a-mod2.page.js.map