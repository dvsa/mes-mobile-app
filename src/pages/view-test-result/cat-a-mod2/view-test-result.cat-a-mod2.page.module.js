...
var ViewTestResultCatAMod2PageModule = /** @class */ (function () {
    function ViewTestResultCatAMod2PageModule() {
    }
    ViewTestResultCatAMod2PageModule = __decorate([
        NgModule({
            declarations: [
    ...
    ], ViewTestResultCatAMod2PageModule);
    return ViewTestResultCatAMod2PageModule;
}());
export { ViewTestResultCatAMod2PageModule };
//# sourceMappingURL=view-test-result.cat-a-mod2.page.module.js.map