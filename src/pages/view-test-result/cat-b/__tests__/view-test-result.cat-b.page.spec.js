...
describe('ViewTestResultCatBPage', function () {
    var fixture;
    var component;
    ...
    describe('Class', function () {
        ...
        describe('getVehicleDetails', function () {
            it('should correctly generate the data', function () {
                component.testResult = categoryBTestResultMock;
                var result = component.getVehicleDetails();
        ...
        describe('getDebrief', function () {
            it('should return the correct data', function () {
                component.testResult = categoryBTestResultMock;
                var result = component.getDebrief();
        ...
        describe('getManoeuvres', function () {
            it('should return None where no manoeuvre has been completed', function () {
                expect(component.getManoeuvres()).toEqual(['None']);
            });
            it('should return the correct values for the manoeuvres', function () {
                component.testResult = categoryBTestResultMock;
        ...
        describe('getETA', function () {
            it('should return None when there have been no ETAs', function () {
                expect(component.getETA()).toEqual(['None']);
            });
            it('should return the correct values for the ETAs', function () {
                component.testResult = categoryBTestResultMock;
                expect(component.getETA()).toEqual(['Verbal']);
            });
        });
        describe('getShowMeQuestion', function () {
            it('should return undefined if there is no show me question', function () {
            ...
            it('should return the correct value for a show me question', function () {
                component.testResult = categoryBTestResultMock;
                var result = component.getShowMeQuestion();
        ...
        describe('getTellMeQuestion', function () {
            it('should return undefined if there is no tell me question', function () {
                component.testResult = {
                    category: "B" /* B */,
                    journalData: null,
                    activityCode: null,
            ...
            it('should return the correct value for the tell me question', function () {
                component.testResult = categoryBTestResultMock;
                var result = component.getTellMeQuestion();
                expect(result).toEqual({
                    code: 'T2',
                    description: 
    ...
    describe('DOM', function () {
        ...
        it('should hide the cards and show the error message when there has been an error', function () {
            ...
            expect(fixture.debugElement.query(By.css('rekey-reason-card'))).toBeNull();
            expect(fixture.debugElement.query(By.css('examiner-details-card'))).toBeNull();
            expect(fixture.debugElement.query(By.css('vehicle-details-cat-b-card'))).toBeNull();
            expect(fixture.debugElement.query(By.css('debrief-card'))).toBeNull();
            expect(fixture.debugElement.query(By.css('test-summary-card'))).toBeNull();
        });
        it('should show the cards when the data is not loading and there is no error', function () {
            ...
            expect(fixture.debugElement.query(By.css('vehicle-details-cat-b-card'))).not.toBeNull();
...
//# sourceMappingURL=view-test-result.cat-b.page.spec.js.map