...
describe('ViewTestResultCatADIPart2Page', function () {
    var fixture;
    var component;
    ...
    describe('Class', function () {
        ...
        describe('getTestDetails', function () {
            it('should correctly generate the data', function () {
                ...
                expect(result.category).toBe("ADI2" /* ADI2 */);
    ...
    describe('DOM', function () {
        ...
        it('should show the cards when the data is not loading and there is no error', function () {
            ...
            expect(fixture.debugElement.query(By.css('test-details-card-adi2'))).not.toBeNull();
            expect(fixture.debugElement.query(By.css('vehicle-details-cat-adi-pt2'))).not.toBeNull();
...
//# sourceMappingURL=view-test-result.cat-adi-part2.page.spec.js.map