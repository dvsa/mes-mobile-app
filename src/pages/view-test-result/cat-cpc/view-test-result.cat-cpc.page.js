...
var ViewTestResultCatCPCPage = /** @class */ (function (_super) {
    __extends(ViewTestResultCatCPCPage, _super);
    function ViewTestResultCatCPCPage(navController, platform, navParams, loadingController, authenticationProvider, searchProvider, compressionProvider, store$, logHelper, questionProvider) {
    ...
    ViewTestResultCatCPCPage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.subscription = this.searchProvider
            ...
            _this.testOutcome = getTestOutcomeText(_this.testResult);
        });
    };
    ViewTestResultCatCPCPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    ViewTestResultCatCPCPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new ViewTestResultViewDidEnter(this.applicationReference));
    };
    ViewTestResultCatCPCPage.prototype.getTestDetails = function () {
        if (!this.testResult) {
            return null;
        }
    ...
    ViewTestResultCatCPCPage.prototype.getExaminerDetails = function () {
        if (!this.testResult) {
            return null;
        }
        return {
    ...
    ViewTestResultCatCPCPage.prototype.getHeaderDetails = function () {
        if (!this.testResult) {
            return null;
        }
        return {
    ...
    ViewTestResultCatCPCPage = __decorate([
        IonicPage(),
        Component({
    ...
    return ViewTestResultCatCPCPage;
}(BasePageComponent));
export { ViewTestResultCatCPCPage };
//# sourceMappingURL=view-test-result.cat-cpc.page.js.map