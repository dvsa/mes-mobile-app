...
describe('DebriefCardComponent', function () {
    ...
    describe('Class', function () {
        describe('getTestRequirements', function () {
            it('should return the correct values for all test requirements for Cat D', function () {
                var data = {
                    testRequirements: {
            ...
            it('should return the correct values for all test requirements for Cat DE', function () {
                var data = {
                    testRequirements: {
                        angledStartControlledStop: true,
                        downhillStart: false,
            ...
            it('should return the correct values for all test requirements for Cat D1', function () {
                var data = {
                    testRequirements: {
                        angledStartControlledStop: true,
                        downhillStart: false,
            ...
            it('should return the correct values for all test requirements for Cat D1E', function () {
                var data = {
                    testRequirements: {
                        angledStartControlledStop: true,
                        downhillStart: false,
