        ...
        this.getTestRequirements = function () {
            var testRequirements = [
                ...
                },
                {
                    ...
                    checked: get(_this.data, 'testRequirements.busStop1', false),
                },
                {
                    label: TestRequirementsLabels.busStop2,
                    checked: get(_this.data, 'testRequirements.busStop2', false),
                },
                {
            ...
            if (_this.category === "D1+E" /* D1E */ || _this.category === "D+E" /* DE */) {
