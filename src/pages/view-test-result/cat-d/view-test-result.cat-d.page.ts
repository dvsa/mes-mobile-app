...
export class ViewTestResultCatDPage extends BasePageComponent implements OnInit {

  applicationReference: string = '';
  testResult: CatDUniqueTypes.TestResult;
  ...
  ngOnInit(): void {
    ...
    this.subscription = this.searchProvider
      ...
      .pipe(
        ...
        map(data => this.testResult = this.compressionProvider.extractTestResult(data) as CatDUniqueTypes.TestResult),
