...
describe('JournalEarlyStartModal', function () {
    var modalFixture;
    var modalComponent;
    var mockFile = new JournalEarlyStartModalMock();
    ...
    beforeEach(async(function () {
        var mockValue = mockFile.mockSlotDetail();
        ...
        spyOn(modalComponent.store$, 'dispatch').and.callFake(function () { });
    }));
    it('should return slot details from nav param', function () {
        modalFixture.detectChanges();
        var slotData = modalComponent.getSlotData();
        var mockValue = mockFile.mockSlotDetail();
        expect(slotData).toEqual(mockValue);
    });
    it('should call onStart when the Start test button is clicked', function () {
        modalFixture.detectChanges();
        spyOn(modalComponent, 'onStart').and.callThrough();
        var button = modalFixture.debugElement.query(By.css('.start-test-button'));
    ...
    it('should call onCancel when the Cancel button is clicked', function () {
        ...
        var button = modalFixture.debugElement.query(By.css('.cancel-button'));
        button.triggerEventHandler('click', null);
        modalFixture.detectChanges();
...
//# sourceMappingURL=journal-early-start-modal.spec.js.map