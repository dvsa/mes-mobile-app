...
import { ShowMeQuestionSelected, } from '../../../../modules/tests/test-data/cat-b/vehicle-checks/vehicle-checks.actions';
...
describe('OfficePage', function () {
    ...
    describe('Class', function () {
        ...
        describe('selecting a show me question', function () {
            it('should dispatch an action when show me question change handler is called', function () {
                var question = {
                    code: 'S1',
                    description: 'desc',
                    shortName: 'name',
        ...
        describe('completeTest', function () {
            ...
            it('should not dispatch complete test if in practice mode', function () {
                component.isPracticeMode = true;
                component.completeTest();
                expect(store$.dispatch).not.toHaveBeenCalledWith(new CompleteTest());
            });
        });
        describe('shouldDisplayDrivingFaultComments', function () {
            it('should return false if there are less than 16 driving faults', function () {
                ...
                var result = component.shouldDisplayDrivingFaultComments({});
                expect(result).toEqual(false);
            });
            it('should return true if there are more than 15 driving faults and no serious or dangerous faults', function () {
            ...
            it('should return false if there are more than 15 driving faults and a serious fault', function () {
                spyOn(faultCountProvider, 'getDrivingFaultSumCount').and.returnValue(16);
            ...
            it('should return false if there are more than 15 driving faults and a dangerous fault', function () {
                spyOn(faultCountProvider, 'getDrivingFaultSumCount').and.returnValue(16);
                spyOn(faultCountProvider, 'getSeriousFaultSumCount').and.returnValue(0);
    ...
    describe('DOM', function () {
        it('should pass the selected show me question code to the show me subcomponent', function () {
            fixture.detectChanges();
            var showMeElement = fixture.debugElement.query(By.css('show-me-question'))
                .componentInstance;
...
//# sourceMappingURL=office.cat-b.page.spec.js.map