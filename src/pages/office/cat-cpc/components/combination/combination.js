...
var CombinationComponent = /** @class */ (function () {
    ...
    CombinationComponent.prototype.getCombinationText = function (combinationText) {
    ...
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], CombinationComponent.prototype, "combinationAdditionalText", void 0);
    CombinationComponent = __decorate([
        Component({
