...
import { AdditionalInformationChanged, CandidateDescriptionChanged, IdentificationUsedChanged, } from '../../../../modules/tests/test-summary/common/test-summary.actions';
...
describe('OfficeCatCPCPage', function () {
    var fixture;
    var component;
    var navController;
    var store$;
    ...
    describe('defer', function () {
        it('should call the popTo method', function () {
            spyOn(component, 'popToRoot');
            component.defer();
            expect(component.popToRoot).toHaveBeenCalled();
        });
    });
    describe('getCombinationAdditionalText', function () {
        it('should return the additionalText for the passed in combination code (LGV1)', function () {
            expect(component.getCombinationAdditionalText('LGV1')).toEqual('Fire ex');
        });
        it('should return the additionalText for the passed in combination code (LGV2)', function () {
            expect(component.getCombinationAdditionalText('LGV2')).toEqual('LSDT');
        });
        it('should return the null for the passed in combination code (LGV3) has no additional text', function () {
            expect(component.getCombinationAdditionalText('LGV3')).toEqual(null);
        });
        it('should return null when nothing is passed in', function () {
            expect(component.getCombinationAdditionalText(null)).toEqual(null);
        });
    });
    describe('isFail', function () {
        it('should return false if test outcome is pass', function () {
            component.outcome = TestOutcome.PASS;
            expect(component.isFail()).toEqual(false);
        });
        it('should return true if test outcome is fail', function () {
            component.outcome = TestOutcome.FAIL;
            expect(component.isFail()).toEqual(true);
        });
    });
    describe('onSubmit', function () {
        it('should call showFinishTestModal when form is valid', function () {
            spyOn(component, 'isFormValid').and.returnValue(true);
            spyOn(component, 'showFinishTestModal');
            component.onSubmit();
            expect(component.showFinishTestModal).toHaveBeenCalled();
        });
        it('should not call showFinishTestModal when form is not valid', function () {
    ...
    describe('candidateDescriptionChanged', function () {
        it('should dispatch candidate description to the store', function () {
    ...
    describe('identificationChanged', function () {
        it('should dispatch identification to the store', function () {
    ...
    describe('additionalInformationChanged', function () {
        it('should dispatch additional info to the store', function () {
    ...
    describe('assessmentReportChanged', function () {
        it('should dispatch assessemnt report to the store', function () {
            component.assessmentReportChanged('text');
            expect(store$.dispatch).toHaveBeenCalledWith(new AssessmentReportChanged('text'));
        });
    });
    describe('goToReasonForRekey', function () {
        it('should call navController when form is valid', function () {
            spyOn(component, 'isFormValid').and.returnValue(true);
        ...
        it('should not call navController when form is not valid', function () {
            spyOn(component, 'isFormValid').and.returnValue(false);
            spyOn(component.navController, 'push');
            component.goToReasonForRekey();
    ...
    describe('completeTest', function () {
        it('should dispatch CompleteTest and call pop to root', function () {
            spyOn(component, 'popToRoot');
...
//# sourceMappingURL=office.cat-cpc.page.spec.js.map