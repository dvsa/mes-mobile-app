...
@IonicPage()
@Component({
  selector: '.office-delegated-non-cpc-page',
  templateUrl: 'office.delegated-non-cpc.page.html',
})
export class OfficeDelegatedNonCPCPage extends BasePageComponent {
  ...
  setupSubscription() {
    const { delegatedTest$, transmission$ } = this.pageState;
