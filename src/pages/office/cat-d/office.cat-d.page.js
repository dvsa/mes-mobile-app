...
import { AddShowMeTellMeComment, } from '../../../modules/tests/test-data/cat-d/vehicle-checks/vehicle-checks.cat-d.action';
...
import { vehicleChecksExist, } from '../../../modules/tests/test-data/cat-d/vehicle-checks/vehicle-checks.cat-d.selector';
import { getVehicleChecks } from '../../../modules/tests/test-data/cat-d/test-data.cat-d.selector';
import { getTestCategory } from '../../../modules/tests/category/category.reducer';
import { AddSafetyQuestionComment, } from '../../../modules/tests/test-data/cat-d/safety-questions/safety-questions.cat-d.action';
import { AddPcvDoorExerciseComment, } from '../../../modules/tests/test-data/cat-d/pcv-door-exercise/pcv-door-exercise.actions';
...
var OfficeCatDPage = /** @class */ (function (_super) {
    __extends(OfficeCatDPage, _super);
    function OfficeCatDPage(store$, toastController, navController, navParams, platform, authenticationProvider, weatherConditionProvider, questionProvider, keyboard, outcomeBehaviourProvider, alertController, faultCountProvider, faultSummaryProvider, appConfig) {
    ...
    OfficeCatDPage.prototype.ionViewDidEnter = function () {
        if (!this.subscription || this.subscription.closed) {
            this.setupSubscription();
        }
        this.store$.dispatch(new OfficeViewDidEnter());
    };
    OfficeCatDPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    OfficeCatDPage.prototype.setupSubscription = function () {
        var _this = this;
    ...
    OfficeCatDPage.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    OfficeCatDPage.prototype.popToRoot = function () {
    ...
    OfficeCatDPage.prototype.defer = function () {
        this.popToRoot();
        this.store$.dispatch(new SavingWriteUpForLater());
        this.store$.dispatch(new PersistTests());
    };
    OfficeCatDPage.prototype.onSubmit = function () {
        if (this.isFormValid()) {
            this.showFinishTestModal();
        }
    };
    OfficeCatDPage.prototype.setIsValidStartDateTime = function (isValid) {
        this.isValidStartDateTime = isValid;
    };
    OfficeCatDPage.prototype.dateOfTestChanged = function (inputDate) {
    ...
    OfficeCatDPage.prototype.identificationChanged = function (identification) {
        this.store$.dispatch(new IdentificationUsedChanged(identification));
    };
    OfficeCatDPage.prototype.independentDrivingChanged = function (independentDriving) {
        this.store$.dispatch(new IndependentDrivingTypeChanged(independentDriving));
    };
    OfficeCatDPage.prototype.weatherConditionsChanged = function (weatherConditions) {
        this.store$.dispatch(new WeatherConditionsChanged(weatherConditions));
    };
    OfficeCatDPage.prototype.routeNumberChanged = function (routeNumber) {
        this.store$.dispatch(new RouteNumberChanged(routeNumber));
    };
    OfficeCatDPage.prototype.candidateDescriptionChanged = function (candidateDescription) {
        this.store$.dispatch(new CandidateDescriptionChanged(candidateDescription));
    };
    OfficeCatDPage.prototype.additionalInformationChanged = function (additionalInformation) {
        this.store$.dispatch(new AdditionalInformationChanged(additionalInformation));
    };
    OfficeCatDPage.prototype.dangerousFaultCommentChanged = function (dangerousFaultComment) {
        if (dangerousFaultComment.source === CommentSource.SIMPLE) {
            ...
            this.store$.dispatch(new AddPcvDoorExerciseComment(CompetencyOutcome.D, 'dangerousFaultComments', dangerousFaultComment.comment));
        }
    };
    OfficeCatDPage.prototype.seriousFaultCommentChanged = function (seriousFaultComment) {
        if (seriousFaultComment.source === CommentSource.SIMPLE) {
            ...
            this.store$.dispatch(new AddPcvDoorExerciseComment(CompetencyOutcome.S, 'seriousFaultComments', seriousFaultComment.comment));
        }
    };
    OfficeCatDPage.prototype.drivingFaultCommentChanged = function (drivingFaultComment) {
        if (drivingFaultComment.source === CommentSource.SIMPLE) {
            ...
            this.store$.dispatch(new AddPcvDoorExerciseComment(CompetencyOutcome.DF, 'drivingFaultComments', drivingFaultComment.comment));
        }
    };
    OfficeCatDPage.prototype.activityCodeChanged = function (activityCodeModel) {
    ...
    OfficeCatDPage.prototype.showFinishTestModal = function () {
        var _this = this;
    ...
    OfficeCatDPage.prototype.goToReasonForRekey = function () {
        if (this.isFormValid()) {
            this.navController.push(CAT_D.REKEY_REASON_PAGE);
        }
    };
    OfficeCatDPage.prototype.isFormValid = function () {
        var _this = this;
    ...
    OfficeCatDPage.prototype.completeTest = function () {
        if (!this.isDelegated) {
    ...
    OfficeCatDPage.prototype.provisionalLicenseReceived = function () {
        this.store$.dispatch(new ProvisionalLicenseReceived());
    };
    OfficeCatDPage.prototype.provisionalLicenseNotReceived = function () {
        this.store$.dispatch(new ProvisionalLicenseNotReceived());
    };
    OfficeCatDPage.prototype.transmissionChanged = function (transmission) {
        this.store$.dispatch(new GearboxCategoryChanged(transmission));
    };
    OfficeCatDPage.prototype.healthDeclarationChanged = function (healthSigned) {
        this.store$.dispatch(new postTestDeclarationsActions.HealthDeclarationAccepted(healthSigned));
    };
    OfficeCatDPage.prototype.passCertificateNumberChanged = function (passCertificateNumber) {
    ...
    OfficeCatDPage.prototype.d255Changed = function (d255) {
        this.store$.dispatch(d255 ? new D255Yes() : new D255No());
    };
    OfficeCatDPage.prototype.debriefWitnessedChanged = function (debriefWitnessed) {
        this.store$.dispatch(debriefWitnessed ? new DebriefWitnessed() : new DebriefUnwitnessed());
    };
    OfficeCatDPage.prototype.isWelshChanged = function (isWelsh) {
    ...
    return OfficeCatDPage;
}(BasePageComponent));
export { OfficeCatDPage };
//# sourceMappingURL=office.cat-d.page.js.map