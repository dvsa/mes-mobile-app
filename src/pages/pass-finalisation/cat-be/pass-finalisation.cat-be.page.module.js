...
var PassFinalisationCatBEPageModule = /** @class */ (function () {
    function PassFinalisationCatBEPageModule() {
    }
    PassFinalisationCatBEPageModule = __decorate([
        NgModule({
            declarations: [
    ...
    return PassFinalisationCatBEPageModule;
}());
export { PassFinalisationCatBEPageModule };
//# sourceMappingURL=pass-finalisation.cat-be.page.module.js.map