...
import { getPassCompletion } from '../../../modules/tests/pass-completion/cat-a-mod1/pass-completion.cat-a-mod1.reducer';
import { getPassCertificateNumber, } from '../../../modules/tests/pass-completion/cat-a-mod1/pass-completion.cat-a-mod1.selector';
...
var PassFinalisationCatAMod1Page = /** @class */ (function (_super) {
    __extends(PassFinalisationCatAMod1Page, _super);
    function PassFinalisationCatAMod1Page(store$, navController, navParams, platform, authenticationProvider, outcomeBehaviourProvider) {
        ...
        _this.category = "EUA1M1" /* EUA1M1 */;
        _this.form = new FormGroup({});
        _this.outcomeBehaviourProvider.setBehaviourMap(behaviourMap);
        return _this;
    }
    PassFinalisationCatAMod1Page.prototype.ngOnInit = function () {
        var _this = this;
    ...
    PassFinalisationCatAMod1Page.prototype.ionViewDidLeave = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    PassFinalisationCatAMod1Page.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new PassFinalisationViewDidEnter());
        if (this.subscription.closed && this.merged$) {
            this.subscription = this.merged$.subscribe();
        }
    };
    PassFinalisationCatAMod1Page.prototype.transmissionChanged = function (transmission) {
        this.store$.dispatch(new GearboxCategoryChanged(transmission));
    };
    PassFinalisationCatAMod1Page.prototype.onSubmit = function () {
        var _this = this;
    ...
    PassFinalisationCatAMod1Page.prototype.passCertificateNumberChanged = function (passCertificateNumber) {
        this.store$.dispatch(new PassCertificateNumberChanged(passCertificateNumber));
    };
    PassFinalisationCatAMod1Page.prototype.d255Changed = function (d255) {
        this.store$.dispatch(d255 ? new D255Yes() : new D255No());
    };
    PassFinalisationCatAMod1Page.prototype.debriefWitnessedChanged = function (debriefWitnessed) {
        this.store$.dispatch(debriefWitnessed ? new DebriefWitnessed() : new DebriefUnwitnessed());
    };
    PassFinalisationCatAMod1Page.prototype.isWelshChanged = function (isWelsh) {
    ...
    PassFinalisationCatAMod1Page.prototype.displayTransmissionBanner = function () {
        return !this.form.controls['transmissionCtrl'].pristine && this.transmission === TransmissionType.Automatic;
    };
    PassFinalisationCatAMod1Page.prototype.categoryCodeChanged = function (category) {
        this.store$.dispatch(new PopulateTestCategory(category));
    };
    __decorate([
        ViewChild('passCertificateNumberInput'),
        __metadata("design:type", ElementRef)
    ], PassFinalisationCatAMod1Page.prototype, "passCertificateNumberInput", void 0);
    PassFinalisationCatAMod1Page = __decorate([
        IonicPage(),
        Component({
    ...
    return PassFinalisationCatAMod1Page;
}(BasePageComponent));
export { PassFinalisationCatAMod1Page };
//# sourceMappingURL=pass-finalisation.cat-a-mod1.page.js.map