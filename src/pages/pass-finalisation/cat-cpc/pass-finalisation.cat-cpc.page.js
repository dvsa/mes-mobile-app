...
var PassFinalisationCatCPCPage = /** @class */ (function (_super) {
    __extends(PassFinalisationCatCPCPage, _super);
    function PassFinalisationCatCPCPage(store$, navController, navParams, platform, authenticationProvider, outcomeBehaviourProvider) {
    ...
    PassFinalisationCatCPCPage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.merged$ = merge(testCategory$.pipe(map(function (value) { return _this.testCategory = value; })));
        this.subscription = this.merged$.subscribe();
    };
    PassFinalisationCatCPCPage.prototype.ionViewDidLeave = function () {
        if (this.inputSubscriptions) {
            this.inputSubscriptions.forEach(function (sub) { return sub.unsubscribe(); });
        }
    };
    PassFinalisationCatCPCPage.prototype.ionViewDidEnter = function () {
        this.store$.dispatch(new PassFinalisationViewDidEnter());
    };
    PassFinalisationCatCPCPage.prototype.onSubmit = function () {
        var _this = this;
    ...
    PassFinalisationCatCPCPage.prototype.passCertificateNumberChanged = function (passCertificateNumber) {
        this.store$.dispatch(new PassCertificateNumberChanged(passCertificateNumber));
    };
    PassFinalisationCatCPCPage.prototype.debriefWitnessedChanged = function (debriefWitnessed) {
        this.store$.dispatch(debriefWitnessed ? new DebriefWitnessed() : new DebriefUnwitnessed());
    };
    PassFinalisationCatCPCPage.prototype.isWelshChanged = function (isWelsh) {
    ...
    ], PassFinalisationCatCPCPage.prototype, "passCertificateNumberInput", void 0);
    PassFinalisationCatCPCPage = __decorate([
        IonicPage(),
        Component({
    ...
    return PassFinalisationCatCPCPage;
}(BasePageComponent));
export { PassFinalisationCatCPCPage };
//# sourceMappingURL=pass-finalisation.cat-cpc.page.js.map