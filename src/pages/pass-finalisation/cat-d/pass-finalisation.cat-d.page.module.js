...
var PassFinalisationCatDPageModule = /** @class */ (function () {
    function PassFinalisationCatDPageModule() {
    }
    PassFinalisationCatDPageModule = __decorate([
        NgModule({
            declarations: [
    ...
    ], PassFinalisationCatDPageModule);
    return PassFinalisationCatDPageModule;
}());
export { PassFinalisationCatDPageModule };
//# sourceMappingURL=pass-finalisation.cat-d.page.module.js.map