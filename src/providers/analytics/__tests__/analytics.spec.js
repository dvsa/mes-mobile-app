...
describe('Analytics Provider', function () {
    ...
    configureTestSuite(function () {
        TestBed.configureTestingModule({
            providers: [
                ...
                { provide: GoogleAnalytics, useFactory: function () { return GoogleAnalyticsMock.instance(); } },
    ...
    describe('setUserId', function () {
        it('should hash the userId for 123 correctly', function () {
        ...
        it('should hash the userId for 456 correctly', function () {
            expect(googleAnalyticsMock).toBeDefined();
        ...
        it('should hash the userId consistently when no value is available', function () {
            expect(googleAnalyticsMock).toBeDefined();
    ...
    describe('setDeviceId', function () {
        it('should hash the userId for abcdef123456 correctly', function () {
            expect(googleAnalyticsMock).toBeDefined();
        ...
        it('should hash the userId for aabbccddeeff correctly', function () {
            expect(googleAnalyticsMock).toBeDefined();
