  ...
  describe('CAT B unique outcome testing', () => {
    describe('outcome 1', () => {
      it(`should return visibility Y for all fields but eta,faultComment and eco`, () => {
        ...
        const tellMe = outcomeBehaviourMapProvider.getVisibilityType('1', 'tellMeQuestion');
        const showMe = outcomeBehaviourMapProvider.getVisibilityType('1', 'showMeQuestion');
  ...
  describe('outcome testing', () => {
    ...
    describe('outcome 4', () => {
      it(`should return visibility Y for all fields but eta,faultComment and eco`, () => {
        ...
        const tellMe = outcomeBehaviourMapProvider.getVisibilityType('4', 'tellMeQuestion');
        const showMe = outcomeBehaviourMapProvider.getVisibilityType('4', 'showMeQuestion');
    ...
    describe('outcome 11', () => {
      it(`should return visibility Y for all fields but eta,faultComment and eco`, () => {
        ...
        const tellMe = outcomeBehaviourMapProvider.getVisibilityType('11', 'tellMeQuestion');
        const showMe = outcomeBehaviourMapProvider.getVisibilityType('11', 'showMeQuestion');
    ...
    describe('outcome 20', () => {
      ...
      it(`should return visibility N for all other fields`, () => {
        ...
        const tellMe = outcomeBehaviourMapProvider.getVisibilityType('20', 'tellMeQuestion');
        const showMe = outcomeBehaviourMapProvider.getVisibilityType('20', 'showMeQuestion');
    ...
    describe('outcome 21', () => {
      ...
      it(`should return visibility N for all other fields`, () => {
        ...
        const showMe = outcomeBehaviourMapProvider.getVisibilityType('21', 'showMeQuestion');
    ...
    describe('outcome 22', () => {
      ...
      it(`should return visibility Y for all other fields`, () => {
        ...
        const showMe = outcomeBehaviourMapProvider.getVisibilityType('22', 'showMeQuestion');
    ...
    describe('outcome 23', () => {
      ...
      it(`should return visibility Y for all other fields`, () => {
        ...
        const tellMe = outcomeBehaviourMapProvider.getVisibilityType('23', 'tellMeQuestion');
        const showMe = outcomeBehaviourMapProvider.getVisibilityType('23', 'showMeQuestion');
    ...
    describe('outcome 33', () => {
      ...
      it(`should return visibility N for all other fields`, () => {
        ...
        const showMe = outcomeBehaviourMapProvider.getVisibilityType('33', 'showMeQuestion');
    ...
    describe('outcome 40', () => {
      ...
      it(`should return visibility N for all other fields`, () => {
        ...
        const showMe = outcomeBehaviourMapProvider.getVisibilityType('40', 'showMeQuestion');
    ...
    describe('outcome 51', () => {
      ...
      it(`should return visibility N for all other fields`, () => {
        ...
        const showMe = outcomeBehaviourMapProvider.getVisibilityType('51', 'showMeQuestion');
    ...
    describe('outcome 69', () => {
      ...
      it(`should return visibility N for all other fields`, () => {
        ...
        const showMe = outcomeBehaviourMapProvider.getVisibilityType('69', 'showMeQuestion');
