  ...
  describe('getDrivingFaultSumCountCatADIPart2', () => {
    ...
    describe('getSeriousFaultSumCountCatADIPart2', () => {
      ...
      it('Should return 5 when serious fault exists (1 for each type)', () => {
        const temp =
          FaultCountADIPart2Helper.getSeriousFaultSumCountCatADIPart2(catADI2TestDataStateObjectSeriousFaults);
    ...
    describe('getDangerousFaultSumCountCatADIPart2', () => {
      it('Should return 0 when no dangerous faults exist', () => {
        const temp =
          FaultCountADIPart2Helper.getDangerousFaultSumCountCatADIPart2(catADI2TestDataStateObjectNoDrivingFaults);
        expect(temp).toEqual(0);
      });

      it('Should return 4 when dangerous fault exists (1 for each type)', () => {
        const temp =
          FaultCountADIPart2Helper.getDangerousFaultSumCountCatADIPart2(catADI2TestDataStateObjectDangerousFaults);
