...
var CpcQuestionsMock = /** @class */ (function () {
    function CpcQuestionsMock() {
    }
    CpcQuestionsMock.prototype.getQuestionsBank = function () {
        return [
            question('1'),
            question('3'),
            question('7'),
    ...
    CpcQuestionsMock.prototype.getQuestion5ByVehicleType = function (combinationCode) {
        return combinationCode.includes('LGV') ? lgvQuestion5 : pcvQuestion5;
    };
    CpcQuestionsMock.prototype.getQuestionScore = function () {
        return 15;
    };
    CpcQuestionsMock.prototype.getTotalQuestionScore = function () {
        return 80;
    };
    CpcQuestionsMock.prototype.getCombinations = function (combinationCode) {
    ...
    return CpcQuestionsMock;
}());
export { CpcQuestionsMock };
//# sourceMappingURL=cpc-questions.mock.js.map