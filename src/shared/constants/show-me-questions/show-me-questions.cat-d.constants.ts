...
export const questions: VehicleChecksQuestion[] = [
  ...
  {
    code: 'V13',
    description: 'Show me where the first aid equipment and fire extinguisher is kept on this vehicle.',
    shortName: 'First aid / Fire extinguisher',
  },
  {
    code: 'V15',
    description: 'Show me where the fuel cut off device is on this vehicle.',
    shortName: 'Fuel cut off device',
  },
  {
    code: 'V16',
