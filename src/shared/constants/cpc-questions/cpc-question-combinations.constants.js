export var QuestionNumber;
(function (QuestionNumber) {
    QuestionNumber[QuestionNumber["ONE"] = 0] = "ONE";
    QuestionNumber[QuestionNumber["TWO"] = 1] = "TWO";
    QuestionNumber[QuestionNumber["THREE"] = 2] = "THREE";
    QuestionNumber[QuestionNumber["FOUR"] = 3] = "FOUR";
    QuestionNumber[QuestionNumber["FIVE"] = 4] = "FIVE";
})(QuestionNumber || (QuestionNumber = {}));
export var questionCombinations = [
    {
        code: 'LGV1',
...
//# sourceMappingURL=cpc-question-combinations.constants.js.map