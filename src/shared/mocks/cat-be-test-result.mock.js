export var categoryBETestResultMock = {
    version: '0.0.1',
    category: 'B+E',
    activityCode: '2',
    rekey: true,
    ...
    testData: {
        uncoupleRecouple: {
            selected: true,
            fault: 'S',
            faultComments: 'Candidate forgot to recouple the trailer',
        },
        dangerousFaults: {
        ...
        eyesightTest: {
            complete: true,
            seriousFault: false,
            faultComments: 'Candidate is blind',
        },
        manoeuvres: {
            reverseLeft: {
                selected: true,
...
//# sourceMappingURL=cat-be-test-result.mock.js.map